...
begin
    try
      ...
      on error : Exception do
      begin
          UTI_GEN_Error_Log( 'Error al comprobar si la password existe ya. La tabla ha sido ' +
    ...
    try
      ...
      { ****************************************************************************
        ...
        **************************************************************************** }
        ...
        var_SQL.Add(' WHERE upe.Tipo_CRUD = ' +  UTI_GEN_Comillas(Trim(param_Tipo_CRUD)) );
      ...
      on error : Exception do
      begin
          UTI_GEN_Error_Log( 'Error al comprobar si el permiso para el menu/módulo existe ya para' +
                             ' este usuario. La tabla ha sido ' + var_SQLQuery.Name +
