...
type
  ...
  function  UTI_COMPRAS_Traer_Empresas_xID( param_id : ShortString ) : TEmpresas;
...
begin
    ...
    begin
        ...
        begin
            ...
            // ************************************************************************************* //
           param_Registro_Empresa := UTI_COMPRAS_Traer_Empresas_xID( Trim(param_Registro_Empresa.id) );
...
begin
    try
        ...
        // ***************************************************************************************** //
        var_SQLQuery          := TSQLQuery.Create(nil);
        var_SQLQuery.Name     := 'SQLQuery_UTI_COMPRAS_Traer_Empresas_xID';
        var_SQLQuery.Database := var_SQLConnector;
