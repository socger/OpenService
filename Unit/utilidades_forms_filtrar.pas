...
type
    ...
    function UTI_Abrir_Modulo_Elegir_Diario_Tipo( p_Filtros : AnsiString; p_OrderBy : AnsiString; param_Elegimos : Boolean; param_Solo_Ver : Boolean; param_hacemos_commit_alFinalizar : String ) : TRecord_Rgtro_Comun;
