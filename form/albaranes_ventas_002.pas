...
uses
  ...
  StdCtrls, DbCtrls, ExtCtrls, Buttons, utilidades_forms_Filtrar, utilidades_general,
  utilidades_impuestos, utilidades_lineas_detalle, utilidades_stock, LCLTranslator, utilidades_usuarios;
...
resourcestring
  ...
  rs_FormClose_3_1 = '* Del artículo <<< ';
  rs_FormClose_3_2 = 'su stock actual en el almacén <<< ';
  rs_FormClose_3_3 = 'es de ';
  rs_FormClose_3_4 = ', así que no puedo crear la línea con ';
  rs_FormClose_3_5 = ' unidades a descontar del stock.';
...
type
  ...
  { Tform_albaranes_ventas_002 }

  Tform_albaranes_ventas_002 = class(TForm)
    ...
    procedure DBCheckBox_Estudia_SNChange(Sender: TObject);
...
var
  form_albaranes_ventas_002: Tform_albaranes_ventas_002;

implementation

{$R *.lfm}

uses menu, albaranes_ventas_000, albaranes_ventas_001, articulos_ultimas_ventas_000;

{ Tform_albaranes_ventas_002 }

procedure Tform_albaranes_ventas_002.FormActivate(Sender: TObject);
begin
...
function Tform_albaranes_ventas_002.Comprobar_No_Tocar( param_Reproducir_Mensajes,
...
procedure Tform_albaranes_ventas_002.Edit_Descripcion_ImpuestoClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    begin
        ...
        begin
            FieldByName('id_impuestos_Ventas').Clear;
...
procedure Tform_albaranes_ventas_002.FormCreate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
procedure Tform_albaranes_ventas_002.para_Empezar;
begin
    // ********************************************************************************************* //
    // ** Solo para formularios que traten con datos                                              ** //
    // ********************************************************************************************* //
...
procedure Tform_albaranes_ventas_002.OKButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := true;
end;

procedure Tform_albaranes_ventas_002.CancelButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := false;
end;

procedure Tform_albaranes_ventas_002.Boton_Elegir_ImpuestoClick(Sender: TObject);
        ...
        begin
            ...
            begin
                ...
                if UTI_IMPTOS_Existe_el_impto_NOcompuesto_como_compuesto( FieldByName('id_albaranes').AsString,
                                                                          var_Registro.id_1,
                                                                          'albaranes_ventas_detalles' ) <> '0' then
                begin
                    var_msg := TStringList.Create;
...
procedure Tform_albaranes_ventas_002.DBEdit_Descuento_Comercial_1Exit(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_albaranes_ventas_002.DBEdit_Descuento_Comercial_2Exit(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_albaranes_ventas_002.DBEdit_CtdadExit(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_albaranes_ventas_002.DBEdit_PVPExit(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_albaranes_ventas_002.Edit_Descripcion_AlmacenClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_albaranes_ventas_000.SQLQuery_Alb_Detalles.FieldByName('id_almacenes').Clear;
         Edit_Descripcion_Almacen.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_albaranes_ventas_002.Boton_Elegir_AlmacenClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb_Detalles do
    begin
...
procedure Tform_albaranes_ventas_002.Edit_Descripcion_ArticuloClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_albaranes_ventas_000.SQLQuery_Alb_Detalles.FieldByName('id_articulos').Clear;
         form_albaranes_ventas_000.SQLQuery_Alb_Detalles.FieldByName('Repetir_Cada').Clear;
...
procedure Tform_albaranes_ventas_002.Presentar_Datos;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb do
    begin
        Edit_Descripcion_Cliente.Text      := form_albaranes_ventas_001.Edit_Descripcion_Cliente.Text;
        Edit_Descripcion_id_Vehiculos.Text := form_albaranes_ventas_001.Edit_Descripcion_id_Vehiculos.Text;
        Edit_Descripcion_Almacen.Text      := form_albaranes_ventas_001.Edit_Descripcion_Almacen.Text;
        Edit_Descripcion_Almacen1.Text     := form_albaranes_ventas_001.Edit_Descripcion_Almacen.Text;
        Edit_Descripcion_Empresa.Text      := form_albaranes_ventas_001.Edit_Descripcion_Empresa.Text;
    end;
...
procedure Tform_albaranes_ventas_002.Presentar_Descripcion_en_Amarillo_o_no;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb_Detalles do
    begin
...
procedure Tform_albaranes_ventas_002.DBCheckBox_Estudia_SNChange(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_albaranes_ventas_002.Edit_PVP_Imptos_IncluidosExit(
  Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_albaranes_ventas_002.Validacion( param_msg, param_msg_sin_Obligar : TStrings );
...
begin
    ...
    begin
        ...
        begin
            ...
            begin
                param_msg.Add( ' ');
                param_msg.Add( rs_FormClose_3_1 + Trim(Edit_Descripcion_Articulo.Text) +
                             ' >>>' );

                param_msg.Add( rs_FormClose_3_2 +
                              Trim(Edit_Descripcion_Almacen1.Text) +
                              ' >>>' );

                param_msg.Add( rs_FormClose_3_3 + FloatToStr(var_Stock_Articulo.Stock) +
                             rs_FormClose_3_4 +
        ...
        var_almacen := form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('id_almacenes').AsString;
...
procedure Tform_albaranes_ventas_002.FormClose(Sender: TObject; var CloseAction: TCloseAction);
var var_msg             : TStrings;
...
procedure Tform_albaranes_ventas_002.no_Tocar;
begin
    Panel_Mantenimiento.Enabled := False;
end;

procedure Tform_albaranes_ventas_002.Calcular_Importe_menos_Descuento;
var var_msg  : TStrings;
    var_Calc : Extended;
begin
    var_msg := TStringList.Create;

    UTI_LINEAS_Controlar_PVP( form_albaranes_ventas_000.SQLQuery_Alb_Detalles,
...
procedure Tform_albaranes_ventas_002.Boton_Buscar_Referencia_ArticuloClick(Sender: TObject);
var var_msg      : TStrings;
    var_Devuelve : String;
begin
    var_msg := TStringList.Create;
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                // ********************************************************************************* //
                var_Devuelve := UTI_LINEAS_Buscar_Articulo_por_Referencia( form_albaranes_ventas_000.SQLQuery_Alb_Detalles,
...
procedure Tform_albaranes_ventas_002.Boton_ver_HistoricoClick(Sender: TObject);
var var_msg  : TStrings;
...
begin
    ...
    begin
        ...
        begin
            ...
            begin
                var_Form.Edit_id_clientes.Text         := FieldByName('id_clientes').AsString;
                var_Form.Edit_Descripcion_Cliente.Text := FieldByName('OT_descripcion_cliente').AsString;
            end;
        end;
...
procedure Tform_albaranes_ventas_002.Boton_Elegir_ArticuloClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb_Detalles do
    begin
        ...
        if var_Registro.id_1 <> '' then
        begin
            Edit_Descripcion_Impuesto.Text := UTI_LINEAS_Traer_Resto_Datos_Articulo( form_albaranes_ventas_000.SQLQuery_Alb_Detalles,
                                                                                     var_Registro.id_1,
                                                                                     true,
                                                                                     '' );
