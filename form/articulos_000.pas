...
resourcestring
  ...
  rs_Existe_el_Articulo_Ya_1 = 'Error al comprobar si el artículo existe ya.';
  rs_Existe_el_Articulo_Ya_2 = 'La tabla ha sido ';
  rs_Existe_el_Articulo_Ya_3 = ' desde el módulo ';
...
type
    ...
    Tform_articulos_000 = class(TForm)
      BitBtn_Filtrar: TBitBtn;
        ...
        function  Existe_el_Articulo_Ya( param_id, param_descripcion : ShortString ) : Trecord_Existe;
...
function Tform_articulos_000.Existe_el_Articulo_Ya( param_id,
    ...
    try
      ...
      { ****************************************************************************
        ...
        **************************************************************************** }
        ...
        var_SQL.Add(  'FROM articulos AS a' );
      ...
      { ****************************************************************************
        ...
        **************************************************************************** }
        ...
        var_SQLQuery.Name := 'SQLQuery_Existe_el_Articulo_Ya';
      ...
      { ****************************************************************************
        ...
        **************************************************************************** }
        ...
        var_SQLConnector.Free;
         ...
         begin
             UTI_GEN_Error_Log( rs_Existe_el_Articulo_Ya_1 +
                                rs_Existe_el_Articulo_Ya_2 + var_SQLQuery.Name +
                                rs_Existe_el_Articulo_Ya_3 + Screen.ActiveForm.Name,
                                error );
             try
                 var_SQL.Free;
                 var_SQLTransaction.Free;
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                begin
                    var_record_Existe := Existe_el_Articulo_Ya( '',
        ...
        if RecordCount > 0 then
            begin
                ...
                begin
                    ...
                    if form_articulos_001.public_Pulso_Aceptar = true then
                        begin
                            var_record_Existe := Existe_el_Articulo_Ya( FieldByName('id').AsString,
                                                                        FieldByName('descripcion').AsString );
