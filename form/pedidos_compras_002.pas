...
type
  ...
  { Tform_pedidos_compras_002 }

  Tform_pedidos_compras_002 = class(TForm)
...
var
  form_pedidos_compras_002: Tform_pedidos_compras_002;

implementation

{$R *.lfm}

uses menu, pedidos_compras_000, pedidos_compras_001, articulos_ultimas_ventas_000;

{ Tform_pedidos_compras_002 }

procedure Tform_pedidos_compras_002.FormActivate(Sender: TObject);
begin
...
function Tform_pedidos_compras_002.Comprobar_No_Tocar( param_Reproducir_Mensajes,
...
procedure Tform_pedidos_compras_002.FormClose(Sender: TObject; var CloseAction: TCloseAction);
var var_msg             : TStrings;
...
begin
    ...
    begin
        ...
        begin
            ...
            var_almacen := form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('id_almacenes').AsString;
...
procedure Tform_pedidos_compras_002.FormCreate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
procedure Tform_pedidos_compras_002.para_Empezar;
begin
    // ********************************************************************************************* //
    // ** Solo para formularios que traten con datos                                              ** //
    // ********************************************************************************************* //
...
procedure Tform_pedidos_compras_002.no_Tocar;
begin
    Panel_Mantenimiento.Enabled := False;
end;

procedure Tform_pedidos_compras_002.OKButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := true;
end;

procedure Tform_pedidos_compras_002.CancelButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := false;
end;

procedure Tform_pedidos_compras_002.Presentar_Datos;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo do
    begin
        Edit_Descripcion_Proveedor.Text := form_pedidos_compras_001.Edit_Descripcion_Proveedor.Text;
        Edit_Descripcion_Almacen.Text   := form_pedidos_compras_001.Edit_Descripcion_Almacen.Text;
        Edit_Descripcion_Almacen1.Text  := form_pedidos_compras_001.Edit_Descripcion_Almacen.Text;
        Edit_Descripcion_Empresa.Text   := form_pedidos_compras_001.Edit_Descripcion_Empresa.Text;
    end;
...
procedure Tform_pedidos_compras_002.Presentar_Descripcion_en_Amarillo_o_no;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo_Detalles do
    begin
...
procedure Tform_pedidos_compras_002.DBCheckBox_Excluido_su_cobro_SNChange(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_pedidos_compras_002.Edit_Descripcion_ImpuestoClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
...
procedure Tform_pedidos_compras_002.Edit_PVP_Imptos_IncluidosExit(
  Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_pedidos_compras_002.Boton_Elegir_ImpuestoClick(Sender: TObject);
        ...
        begin
            ...
            begin
                ...
                if UTI_IMPTOS_Existe_el_impto_NOcompuesto_como_compuesto( FieldByName('id_pedidos').AsString,
                                                                          var_Registro.id_1,
                                                                          'pedidos_compras_detalles' ) <> '0' then
                begin
                    var_msg := TStringList.Create;
...
procedure Tform_pedidos_compras_002.DBEdit_Descuento_Comercial_1Exit(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_pedidos_compras_002.DBEdit_Descuento_Comercial_2Exit(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_pedidos_compras_002.DBEdit_CtdadExit(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_pedidos_compras_002.DBEdit_PVPExit(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_pedidos_compras_002.Edit_Descripcion_AlmacenClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_pedidos_compras_000.SQLQuery_Pdo_Detalles.FieldByName('id_almacenes').Clear;
         Edit_Descripcion_Almacen.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_pedidos_compras_002.Boton_Elegir_AlmacenClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo_Detalles do
    begin
...
procedure Tform_pedidos_compras_002.Edit_Descripcion_ArticuloClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_pedidos_compras_000.SQLQuery_Pdo_Detalles.FieldByName('id_articulos').Clear;
         form_pedidos_compras_000.SQLQuery_Pdo_Detalles.FieldByName('Repetir_Cada').Clear;
...
procedure Tform_pedidos_compras_002.Calcular_Importe_menos_Descuento;
var var_msg  : TStrings;
    var_Calc : Extended;
begin
    var_msg := TStringList.Create;

    UTI_LINEAS_Controlar_PVP( form_pedidos_compras_000.SQLQuery_Pdo_Detalles,
...
procedure Tform_pedidos_compras_002.Boton_Buscar_Referencia_ArticuloClick(Sender: TObject);
var var_msg      : TStrings;
    var_Devuelve : String;
begin
    var_msg := TStringList.Create;
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                // ********************************************************************************* //
                var_Devuelve := UTI_LINEAS_Buscar_Articulo_por_Referencia( form_pedidos_compras_000.SQLQuery_Pdo_Detalles,
...
procedure Tform_pedidos_compras_002.Boton_ver_HistoricoClick(Sender: TObject);
var var_msg  : TStrings;
...
procedure Tform_pedidos_compras_002.Boton_Elegir_ArticuloClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo_Detalles do
    begin
        ...
        if var_Registro.id_1 <> '' then
        begin
            Edit_Descripcion_Impuesto.Text := UTI_LINEAS_Traer_Resto_Datos_Articulo( form_pedidos_compras_000.SQLQuery_Pdo_Detalles,
                                                                                     var_Registro.id_1,
                                                                                     false,
                                                                                     '' );
