...
uses
  ...
  ButtonPanel, ExtCtrls, StdCtrls, DbCtrls, Buttons, ComCtrls, DBGrids, Grids, utilidades_general,
  db, utilidades_rgtro, utilidades_usuarios, utilidades_lineas_detalle, utilidades_forms_Filtrar,
  utilidades_impuestos, utilidades_bd, utilidades_datos_tablas, utilidades_contabilidad, sqldb;

type

  { Tform_facturas_compras_001 }

  Tform_facturas_compras_001 = class(TForm)
    BitBtn_SMS: TBitBtn;
    BitBtn_SMS2: TBitBtn;
    ...
    procedure DBNavigator_RcbosClick(Sender: TObject; Button: TDBNavButtonType);
...
var
  form_facturas_compras_001: Tform_facturas_compras_001;

implementation

{$R *.lfm}

uses menu, facturas_compras_000, proveedores_003, facturas_compras_002, albaranes_compras_000,
     facturas_compras_007;

{ Tform_facturas_compras_001 }

procedure Tform_facturas_compras_001.FormActivate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
procedure Tform_facturas_compras_001.Poner_Total_Lineas_Detalle;
begin
    Label_Ctdad_Rgtros.Caption := IntToStr(form_facturas_compras_000.SQLQuery_Ftra_Detalles.RecordCount);
end;

procedure Tform_facturas_compras_001.DBDateTimePicker_FechaEnter(Sender: TObject);
begin
...
procedure Tform_facturas_compras_001.Boton_cambiar_numeracionClick(Sender: TObject);
begin
    if form_facturas_compras_000.Cambiar_Numeracion_Ftra = true then
    begin
...
procedure Tform_facturas_compras_001.DBDateTimePicker_FechaExit(Sender: TObject);
...
procedure Tform_facturas_compras_001.DBNavigator_RcbosBeforeAction(
...
begin
    case Button of
        ...
        nbRefresh : begin
            form_facturas_compras_000.Refrescar_Registros_Recibos;
            Abort;
        end;
    end;
end;

procedure Tform_facturas_compras_001.DBNavigator_RcbosClick(
  Sender: TObject; Button: TDBNavButtonType);
begin

end;

procedure Tform_facturas_compras_001.FormCreate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
procedure Tform_facturas_compras_001.Validacion( param_msg : TStrings );
...
begin
    ...
    begin
        ...
        if Trim(FieldByName('Numero_Factura_Proveedor').AsString) = '' then
        begin
            param_msg.Add( '* Su número de factura.');
        end;

        if Trim(FieldByName('id_proveedores').AsString) = '' then
        begin
            param_msg.Add( '* El proveedor.');
        end;
        ...
        if not form_facturas_compras_000.SQLQuery_Ftra.FieldByName('id').IsNull then
        begin
            var_mensaje_de_cartera_rcbos := UTI_LINEAS_Cartera_Rcbos_es_diferente_que_Total_Ftra( 'facturas_compras',
                                                                                                  form_facturas_compras_000.SQLQuery_Ftra.FieldByName('id').AsString,
                                                                                                  false ).mensaje;
            if Trim(var_mensaje_de_cartera_rcbos) <> '' then
            begin
                param_msg.Add( var_mensaje_de_cartera_rcbos );
                PageControl_Otros_Datos.ActivePage := TabSheet_Gestion_de_Pagos;
            end;
        end;
        ...
        form_facturas_compras_000.Traer_Numero_Ftra( param_msg,
                                                     FieldByName('id_empresas').AsString,
                                                     FieldByName('OT_descripcion_empresa').AsString );
    end;
end;

procedure Tform_facturas_compras_001.FormClose(Sender: TObject; var CloseAction: TCloseAction);
...
begin
    ...
    begin
        ...
        begin
            // if public_volvemos_a_editar = false then // falla porque le faltan campos required como la fecha
            // begin
...
procedure Tform_facturas_compras_001.para_Empezar;
begin
    // ********************************************************************************************* //
    // ** Solo para formularios que traten con datos                                              ** //
    // ********************************************************************************************* //
...
procedure Tform_facturas_compras_001.Presentar_Datos;
begin
    with form_facturas_compras_000.SQLQuery_Ftra do
    begin
        ...
        form_facturas_compras_000.Presentar_Datos_Totales(1);
    end;
end;

procedure Tform_facturas_compras_001.Presentar_Datos_Proveedor_Generales;
begin
    with form_facturas_compras_000.SQLQuery_Ftra do
    begin
...
procedure Tform_facturas_compras_001.Presentar_Datos_Bancarios;
begin
    with form_facturas_compras_000.SQLQuery_Ftra do
    begin
...
procedure Tform_facturas_compras_001.Presentar_Datos_Comerciales;
begin
    with form_facturas_compras_000.SQLQuery_Ftra do
    begin
...
procedure Tform_facturas_compras_001.Presentar_Datos_Gestion_Cobro;
begin
    with form_facturas_compras_000.SQLQuery_Ftra do
    begin
...
procedure Tform_facturas_compras_001.Presentar_Datos_Direccion_de_Envio;
begin
    with form_facturas_compras_000.SQLQuery_Ftra do
    begin
...
procedure Tform_facturas_compras_001.Presentar_Datos_Agencia_de_Transporte;
begin
    with form_facturas_compras_000.SQLQuery_Ftra do
    begin
...
procedure Tform_facturas_compras_001.OKButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := true;
end;

procedure Tform_facturas_compras_001.CancelButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := false;
end;

procedure Tform_facturas_compras_001.no_Tocar(param_modificar_forma_de_pago : Boolean);
begin
...
function Tform_facturas_compras_001.Comprobar_No_Tocar( param_Reproducir_Mensajes,
        ...
        begin
            ...
            begin
                ...
                begin
                    ...
                    begin
                        var_msg.Add( '* Esta factura de compras tiene recibos de cartera. ' +
                                     'Así que no podemos modificar nada de ella, a excepción de los datos de la gestión de pagos.' );
                        PageControl_Otros_Datos.ActivePage := TabSheet_Gestion_de_Pagos;
                    end;
...
procedure Tform_facturas_compras_001.Refrescar_Registros;
begin
    form_facturas_compras_000.Refrescar_Registros_Detalles;

    form_facturas_compras_000.Presentar_Datos_Totales(1);
end;

procedure Tform_facturas_compras_001.RadioGroup_BajasClick(Sender: TObject);
begin
    //UTI_TB_Ver_Bajas_SN('um', Memo_Filtros.Lines, RadioGroup_Bajas.ItemIndex);
    Refrescar_Registros;
end;

procedure Tform_facturas_compras_001.BitBtn_Ver_Situacion_Registro_compras_detallesClick(Sender: TObject);
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, '', True) = True then
    begin
        if form_facturas_compras_000.SQLQuery_Ftra_Detalles.RecordCount > 0 then
        begin
            UTI_RGTRO_Ver_Estado_Registro( 'facturas_compras_detalles',
                                           form_facturas_compras_000.SQLQuery_Ftra_Detalles,
                                           form_facturas_compras_000.DataSource_Ftra_Detalles,
                                           DBGrid_Detalles );
        end;
    end;
end;

procedure Tform_facturas_compras_001.DBGrid_DetallesDblClick(Sender: TObject);
begin
    Editar_Registro_Detalles;
end;

procedure Tform_facturas_compras_001.DBGrid_DetallesDrawColumnCell( Sender: TObject;
                                                                    const Rect: TRect;
                                                                    DataCol: Integer;
                                                                    Column: TColumn;
...
begin
    ...
    begin
        if form_facturas_compras_000.SQLQuery_Ftra_Detalles.RecordCount = 0 then Exit;
        ...
        begin
            ...
            if (Column.FieldName <> 'Convertida_SN')     and
               (Column.FieldName <> 'Cobro_Excluido_SN') then
            begin
                if not form_facturas_compras_000.SQLQuery_Ftra_Detalles.FieldByName('Serie_Albaran').IsNull then
                     Canvas.StretchDraw(Rect, form_facturas_compras_000.Image_Convertida.Picture.Graphic)
                else DefaultDrawColumnCell(Rect, DataCol, Column, State);
            end;

            if Column.FieldName = 'Cobro_Excluido_SN' then
            begin
                if form_facturas_compras_000.SQLQuery_Ftra_Detalles.FieldByName('Excluido_su_Cobro_SN').Value = 'S' then
                     Canvas.StretchDraw(Rect, form_facturas_compras_000.Image_Cobro_Excluido.Picture.Graphic)
                else DefaultDrawColumnCell(Rect, DataCol, Column, State);
            end;
        end;
...
procedure Tform_facturas_compras_001.DBGrid_DetallesKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
    if Key = 13 then Editar_Registro_Detalles;
end;

procedure Tform_facturas_compras_001.DBNavigator_DetallesBeforeAction( Sender: TObject;
...
function Tform_facturas_compras_001.Traer_Empresas_xID( param_id : ShortString ) : TEmpresas;
...
procedure Tform_facturas_compras_001.Boton_Elegir_EmpresaClick(Sender: TObject);
...
procedure Tform_facturas_compras_001.Edit_Descripcion_EmpresaClick(Sender: TObject);
var var_msg : TStrings;
begin
    ...
    begin
         form_facturas_compras_000.SQLQuery_Ftra.FieldByName('id_empresas').Clear;
         Edit_Descripcion_Empresa.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_facturas_compras_001.Boton_Elegir_AlmacenClick(Sender: TObject);
var var_Registro         : TRecord_Rgtro_Comun;
    var_msg              : TStrings;
...
procedure Tform_facturas_compras_001.Edit_Descripcion_AlmacenClick(Sender: TObject);
var var_msg : TStrings;
begin
    if Cambiamos_Almacen_SN = false then Exit;
    if Esta_Ftra_Tiene_Albaranes = true then Exit;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_facturas_compras_000.SQLQuery_Ftra.FieldByName('id_almacenes').Clear;
         Edit_Descripcion_Almacen.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_facturas_compras_001.Edit_Descripcion_ProveedorClick(Sender: TObject);
begin
    if Esta_Ftra_Tiene_Albaranes = true then Exit;
...
procedure Tform_facturas_compras_001.Boton_Elegir_Forma_PagoClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_facturas_compras_000.SQLQuery_Ftra do
    begin
        ...
        begin
            ...
            UTI_LINEAS_Borrar_Rcbos_Cartera_Ftra( 'P',
                                                  form_facturas_compras_000.SQLQuery_Ftra.FieldByName('id').AsString );
...
procedure Tform_facturas_compras_001.Edit_Descripcion_Forma_PagoClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
...
function Tform_facturas_compras_001.Elegir_Contacto_del_Proveedor : TRecord_Rgtro_Comun;
var var_msg : TStrings;
begin
    Result.id_1 := '';
...
procedure Tform_facturas_compras_001.Boton_Elegir_Contacto_ProveedorClick(Sender: TObject);
var var_Registro          : TRecord_Rgtro_Comun;
...
procedure Tform_facturas_compras_001.Edit_Direccion_de_Envio_con_Quien_HablarClick(Sender: TObject);
begin
    Vaciar_Datos_Envio;
end;

procedure Tform_facturas_compras_001.Vaciar_Datos_Envio;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
...
procedure Tform_facturas_compras_001.Boton_Elegir_Poblacion_EnvioClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_facturas_compras_000.SQLQuery_Ftra do
    begin
...
procedure Tform_facturas_compras_001.Boton_Elegir_Pais_EnvioClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_facturas_compras_000.SQLQuery_Ftra do
    begin
...
procedure Tform_facturas_compras_001.Boton_Elegir_Provincia_EnvioClick(
  Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_facturas_compras_000.SQLQuery_Ftra do
...
procedure Tform_facturas_compras_001.Edit_Direccion_de_Envio_PaisClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
...
procedure Tform_facturas_compras_001.Edit_Direccion_de_Envio_PoblacionClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
...
procedure Tform_facturas_compras_001.Edit_Direccion_de_Envio_ProvinciaClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
...
procedure Tform_facturas_compras_001.Edit_Direccion_de_Envio_Agencia_Transporte_DescripcionClick(Sender: TObject);
begin
    Vaciar_Datos_Agencia_de_Transporte;
end;

procedure Tform_facturas_compras_001.Boton_Elegir_Agencia_TransporteClick(Sender: TObject);
var var_Registro               : TRecord_Rgtro_Comun;
...
procedure Tform_facturas_compras_001.Vaciar_Datos_Agencia_de_Transporte;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
...
procedure Tform_facturas_compras_001.Vaciar_Proveedor_Datos;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
...
procedure Tform_facturas_compras_001.Insertar_Registro_Detalles;
var var_msg  : TStrings;
    var_Form : Tform_facturas_compras_002;
begin
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                // ********************************************************************************* //
                UTI_IMPTOS_Asignar_Impto( form_facturas_compras_000.SQLQuery_Ftra_Detalles,
                ...
                // ********************************************************************************* //
                FieldByName('id_almacenes').Value := form_facturas_compras_000.SQLQuery_Ftra.FieldByName('id_almacenes').Value;
                // ********************************************************************************* //

                FieldByName('id_proveedores').AsString          := form_facturas_compras_000.SQLQuery_Ftra.FieldByName('id_proveedores').AsString;
                FieldByName('Excluido_su_Cobro_SN').AsString := 'N';
                FieldByName('id_facturas').AsString          := form_facturas_compras_000.SQLQuery_Ftra.FieldByName('id').AsString;

                var_Form := Tform_facturas_compras_002.Create(nil);
                ...
                begin
                    ...
                    UTI_RGTRO_Grabar_Antes( 'facturas_compras_detalles',
                                            form_facturas_compras_000.SQLQuery_Ftra_Detalles );
...
procedure Tform_facturas_compras_001.Panel_Fecha_Nueva_FtraEnter(Sender: TObject);
begin
    private_Comprobar := false;
end;

procedure Tform_facturas_compras_001.Borrar_Registro_Detalle;
var var_msg : TStrings;
begin
    if Comprobar_No_Tocar(true, false, true) = true then
    begin
    ...
    begin
        ...
        // ** Continuamos                                                                         ** //
        // ***************************************************************************************** //
        UTI_RGTRO_Borrar( 'facturas_compras_detalles',
                          form_facturas_compras_000.SQLQuery_Ftra_Detalles,
                          public_Solo_Ver,
                          public_Menu_Worked );
...
function Tform_facturas_compras_001.Cambiamos_Almacen_SN : Boolean;
var var_msg : TStrings;
begin
    Result := true;

    if form_facturas_compras_000.SQLQuery_Ftra_Detalles.Active = false then Exit;
...
procedure Tform_facturas_compras_001.Editar_Registro_Detalles;
var var_msg  : TStrings;
    var_Form : Tform_facturas_compras_002;
    var_id   : ShortString;
begin
    ...
    begin
        ...
        begin
            ...
            if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
            begin
                if UTI_RGTRO_isLock( 'facturas_compras_detalles',
                                     var_id,
                                     true ) = true then
                begin
                    Exit;
                end else begin
                    if UTI_RGTRO_Lock( 'facturas_compras_detalles',
                                       var_id ) = true then
                         Edit
                    else Exit;
                end;
                ...
                UTI_RGTRO_UnLock( 'facturas_compras_detalles', var_id );
            end;
        end else begin
...
function Tform_facturas_compras_001.Esta_Ftra_Tiene_Albaranes : Boolean;
var var_msg : TStrings;
begin
    Result := false;
...
procedure Tform_facturas_compras_001.BitBtn_Ver_AlbaranClick(Sender: TObject);
var var_msg : TStrings;
begin
    with form_facturas_compras_000.SQLQuery_Ftra_Detalles do
    begin
...
procedure Tform_facturas_compras_001.Boton_Elegir_ProveedorClick(Sender: TObject);
...
procedure Tform_facturas_compras_001.Editar_Registro_Rcbos;
var var_msg  : TStrings;
    var_Form : Tform_facturas_compras_007;
    var_id   : ShortString;
begin
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                var_Form := Tform_facturas_compras_007.Create(nil);
                ...
                if var_Form.public_Pulso_Aceptar = true then
                begin
                    if UTI_DATOS_TABLA_SeCambioAlgoEnRgtro( form_facturas_compras_000.SQLQuery_Ftra_Rcbos ) = true then
                    begin
                        FieldByName('Change_WHEN').Value    := UTI_CN_Fecha_Hora;
                        FieldByName('Change_Id_User').Value := Form_Menu.public_User;

                        UTI_RGTRO_Grabar_Antes( 'facturas_cobros_pagos',
                                                form_facturas_compras_000.SQLQuery_Ftra_Rcbos );
...
procedure Tform_facturas_compras_001.Insertar_Registro_Rcbos;
var var_msg                        : TStrings;
    var_Form                       : Tform_facturas_compras_007;
...
begin
    ...
    begin
        ...
        if not form_facturas_compras_000.SQLQuery_Ftra.FieldByName('Vencimientos_Cantidad').IsNull then
	begin
            var_ctdad_rcbos_para_esta_Ftra := form_facturas_compras_000.SQLQuery_Ftra.FieldByName('Vencimientos_Cantidad').Value;
        end;
        ...
        begin
            ...
            begin
                ...
                FieldByName('id_proveedores').AsString   := form_facturas_compras_000.SQLQuery_Ftra.FieldByName('id_proveedores').AsString;
                {id_proveedores}
                FieldByName('fecha_expedicion').AsString := form_facturas_compras_000.SQLQuery_Ftra.FieldByName('Fecha').AsString;

                // ********************************************************************************* //
                // ** Vemos cual será la próxima fecha de vencimiento para el recibo              ** //
                // ********************************************************************************* //
                var_Vencimientos_1_Dias := 0;
                if not form_facturas_compras_000.SQLQuery_Ftra.FieldByName('Vencimientos_1_Dias').IsNull then
                begin
                    var_Vencimientos_1_Dias := form_facturas_compras_000.SQLQuery_Ftra.FieldByName('Vencimientos_1_Dias').Value;
                end;

                var_Vencimientos_Dias_Entre := 0;
                if not form_facturas_compras_000.SQLQuery_Ftra.FieldByName('Vencimientos_Dias_Entre').IsNull then
                begin
                    var_Vencimientos_Dias_Entre := form_facturas_compras_000.SQLQuery_Ftra.FieldByName('Vencimientos_Dias_Entre').Value;
                end;

                if RecordCount = 0 then
                begin
                    FieldByName('fecha_vencimiento').AsString := form_facturas_compras_000.SQLQuery_Ftra.FieldByName('Fecha').Value +
                ...
                if not form_facturas_compras_000.SQLQuery_Ftra.FieldByName('Forma_pago_Dia_1').IsNull then
                begin
                    var_Forma_pago_Dia_1 := form_facturas_compras_000.SQLQuery_Ftra.FieldByName('Forma_pago_Dia_1').Value
                end;

                var_Forma_pago_Dia_2 := 0;
                if not form_facturas_compras_000.SQLQuery_Ftra.FieldByName('Forma_pago_Dia_2').IsNull then
                begin
                    var_Forma_pago_Dia_2 := form_facturas_compras_000.SQLQuery_Ftra.FieldByName('Forma_pago_Dia_2').Value
                end;
...
procedure Tform_facturas_compras_001.Borrar_Registro_Rcbos;
begin
    if Comprobar_No_Tocar(true, false, false) = true then
    begin
        Exit;
...
procedure Tform_facturas_compras_001.DBGrid_RcbosDrawColumnCell(
  Sender: TObject; const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
    UTI_GEN_Dibujar_Grid( Sender, form_facturas_compras_000.SQLQuery_Ftra_Rcbos, Rect, DataCol, Column, State );
end;

procedure Tform_facturas_compras_001.Poner_Total_Cartera_Recibos;
begin
    Edit_Total_Rcbos.Text := FloatToStr( UTI_LINEAS_Cartera_Rcbos_es_diferente_que_Total_Ftra( 'facturas_compras',
                                                                                               form_facturas_compras_000.SQLQuery_Ftra.FieldByName('id').AsString,
                                                                                               false ).Cantidad_ya_remesada );
end;

function Tform_facturas_compras_001.Traer_Proveedores_xID( param_id : ShortString ) : TProveedores;
var var_SQLTransaction : TSQLTransaction;
    var_SQLConnector   : TSQLConnector;
    var_SQLQuery       : TSQLQuery;
begin
...
function Tform_facturas_compras_001.Traer_Proveedores_Contactos_xID( param_id : ShortString ) : TProveedores_Contactos;
var var_SQLTransaction : TSQLTransaction;
    var_SQLConnector   : TSQLConnector;
    var_SQLQuery       : TSQLQuery;
begin
