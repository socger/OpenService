...
uses
    ...
    utilidades_forms_Filtrar, db, utilidades_general, LCLTranslator;
...
begin
    If Form_medios_000.public_Elegimos = true then
    begin
        with Self do
        begin
            Color := $00B9959C;
...
function TForm_medios_001.Comprobar_No_Tocar( param_Reproducir_Mensajes,
...
procedure TForm_medios_001.para_Empezar;
begin
    { ****************************************************************************
      Solo para formularios que traten con datos
      **************************************************************************** }
