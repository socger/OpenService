...
uses
    ...
    db, utilidades_forms_Filtrar, utilidades_general, DbCtrls, Buttons;
...
function TForm_users_004.Comprobar_No_Tocar( param_Reproducir_Mensajes,
...
procedure TForm_users_004.para_Empezar;
begin
    { ****************************************************************************
      Solo para formularios que traten con datos
      **************************************************************************** }
