...
type
  ...
  { Tf_servicios_tipos_000 }

  Tf_servicios_tipos_000 = class(Tform_plantilla_000)
...
var
  f_servicios_tipos_000: Tf_servicios_tipos_000;
...
procedure Tf_servicios_tipos_000.Filtrar_tablas_adicionales( var p_Lineas_Filtro : TStrings;
...
procedure Tf_servicios_tipos_000.Cambiar_Nombre_Tabla_Principal;
begin
  pubic_nombre_tabla_Principal := 'servicios_tipos';
end;

procedure Tf_servicios_tipos_000.Cambiar_Titulo_Form;
begin
  Self.Caption := rs_srt_004;
end;

procedure Tf_servicios_tipos_000.Rellenar_Filtros_Impresion(var p_Ordenado_por : String);
begin
  // ********************************************************************************************* //
...
procedure Tf_servicios_tipos_000.Crear_tipos_orden_Principal;
begin
...
procedure Tf_servicios_tipos_000.Crear_OrderBy_tablas_adicionales;
begin
...
procedure Tf_servicios_tipos_000.Refrescar_Registros;
...
procedure Tf_servicios_tipos_000.Refrescar_Registros_TablasLigadas;
begin
  { Hacer algo parecido a lo de abajo pero en plan hereditario con su inherited y todo
...
procedure Tf_servicios_tipos_000.SQLQuery_PrincipalNewRecord(
  DataSet: TDataSet);
begin
  inherited;
...
begin
  p_ctdad_Rgtros             := -1;
  p_Registro_CRUD.name_tabla := 'srt';
...
procedure Tf_servicios_tipos_000.Presentar_Datos_GroupBox_Registro;
begin
...
procedure Tf_servicios_tipos_000.para_Empezar_GroupBox_Registro;
begin
  with SQLQuery_Principal do
  begin
...
procedure Tf_servicios_tipos_000.Cambiar_WindowState;
begin
  Self.WindowState := wsNormal; // Puede ser wsNormal, wsFullScreen, wsMaximized o wsMinimized
end;

procedure Tf_servicios_tipos_000.Abrir_Conexiones_con_BD_TablasAdicionales;
begin
...
procedure Tf_servicios_tipos_000.Cerramos_Tablas_Ligadas;
begin
  { Hacer algo parecido a lo de abajo pero en plan hereditario con su inherited y todo
...
procedure Tf_servicios_tipos_000.Dibujar_Grid_Principal( p_Sender: TObject;
                                                         const p_Rect: TRect;
                                                         p_DataCol: Integer;
                                                         p_Column: TColumn;
...
procedure Tf_servicios_tipos_000.Antes_del_Post_Principal_Sin_Rellenar_Permitido_SI( p_msg : TStrings );
begin
  { Hacer algo parecido a lo de abajo pero en plan hereditario con su inherited y todo
...
procedure Tf_servicios_tipos_000.Antes_del_Post_Principal_Asignar_Valores;
begin
  { Hacer algo parecido a lo de abajo pero en plan hereditario con su inherited y todo
...
procedure Tf_servicios_tipos_000.Antes_del_Post_Principal_Sin_Rellenar_Permitido_NO( p_msg,
...
procedure Tf_servicios_tipos_000.NewRecord_Insert_SQLQuery_Principal;
begin
  { Hacer algo parecido a lo de abajo pero en plan hereditario con su inherited y todo
...
procedure Tf_servicios_tipos_000.Campo_Foco_en_modo_Edicion_Inserccion;
begin
  Self.ActiveControl := DBEdit_Descripcion;
end;

function Tf_servicios_tipos_000.Fue_Utilizado_Rgtro_SQLQuery_Principal : ShortInt;
begin
  Result := 0;
