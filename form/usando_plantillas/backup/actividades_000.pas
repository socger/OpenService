...
resourcestring
  ...
  rs_act_003 = 'Por la id';
  rs_act_004 = 'Mantenimiento de actividades';
  rs_act_005 = '* La descripción';

type

  { Tf_actividades_000 }

  Tf_actividades_000 = class(Tform_plantilla_000)
...
var
  f_actividades_000: Tf_actividades_000;
...
procedure Tf_actividades_000.Filtrar_Principal_queFiltro( var p_Registro_CRUD : TRegistro_CRUD;
                                                          var p_ctdad_Rgtros  : Integer;
                                                          var p_a_Filtrar     : TStrings );
begin
  p_ctdad_Rgtros             := -1;
  p_Registro_CRUD.name_tabla := 'act';
...
procedure Tf_actividades_000.Crear_tipos_orden_Principal;
begin
  SetLength(public_Order_By, 2);

  public_Order_By[0].Titulo       := rs_act_002; // El índice 0 siempre será por el que empezará la aplicación y los filtros
  public_Order_By[0].Memo_OrderBy := 'act.descripcion ASC';

  public_Order_By[1].Titulo       := rs_act_003;
  public_Order_By[1].Memo_OrderBy := 'act.id ASC';
...
procedure Tf_actividades_000.Refrescar_Registros;
...
procedure Tf_actividades_000.Presentar_Datos;
begin
  // *********************************************************************************************** //
...
procedure Tf_actividades_000.Presentar_Datos_GroupBox_Registro;
begin
...
procedure Tf_actividades_000.para_Empezar_GroupBox_Registro;
begin
  with SQLQuery_Principal do
  begin
...
procedure Tf_actividades_000.Cambiar_WindowState;
begin
  Self.WindowState := wsNormal; // Puede ser wsNormal, wsFullScreen, wsMaximized o wsMinimized
end;

procedure Tf_actividades_000.Crear_OrderBy_tablas_adicionales;
begin
...
procedure Tf_actividades_000.Cerramos_Tablas_Ligadas;
begin
  { Hacer algo parecido a lo de abajo pero en plan hereditario con su inherited y todo
...
procedure Tf_actividades_000.Refrescar_Registros_TablasLigadas;
begin
  { Hacer algo parecido a lo de abajo pero en plan hereditario con su inherited y todo
...
procedure Tf_actividades_000.Dibujar_Grid_Principal( p_Sender: TObject;
                                                        const p_Rect: TRect;
                                                        p_DataCol: Integer;
                                                        p_Column: TColumn;
...
procedure Tf_actividades_000.Antes_del_Post_Principal_Sin_Rellenar_Permitido_SI( p_msg : TStrings );
begin
  { Hacer algo parecido a lo de abajo pero en plan hereditario con su inherited y todo
...
procedure Tf_actividades_000.Antes_del_Post_Principal_Asignar_Valores;
begin
  { Hacer algo parecido a lo de abajo pero en plan hereditario con su inherited y todo
...
procedure Tf_actividades_000.Antes_del_Post_Principal_Sin_Rellenar_Permitido_NO( p_msg,
...
procedure Tf_actividades_000.NewRecord_Insert_SQLQuery_Principal;
begin
  { Hacer algo parecido a lo de abajo pero en plan hereditario con su inherited y todo
...
procedure Tf_actividades_000.Campo_Foco_en_modo_Edicion_Inserccion;
begin
...
procedure Tf_actividades_000.Cambiar_Nombre_Tabla_Principal;
begin
  pubic_nombre_tabla_Principal := 'clientes_tipos';
end;
...
procedure Tf_actividades_000.Filtrar_tablas_adicionales( var p_Lineas_Filtro : TStrings;
...
function Tf_actividades_000.Fue_Utilizado_Rgtro_SQLQuery_Principal : ShortInt;
begin
  Result := 0;
