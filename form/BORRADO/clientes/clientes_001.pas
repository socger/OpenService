...
uses
    ...
    utilidades_general, utilidades_forms_Filtrar, Buttons, ExtCtrls, DBGrids, EditBtn, ComCtrls,
    utilidades_bd, sqldb, utilidades_rgtro, utilidades_usuarios, Grids, utilidades_contabilidad,
    types, utilidades_datos_tablas;

type

    { Tform_clientes_001 }

    Tform_clientes_001 = class(TForm)
      BitBtn_eMAIL1: TBitBtn;
        ...
        procedure BitBtn_eMAIL1Click(Sender: TObject);
        ...
        procedure DBMemo_Observaciones_ComentariosChange(Sender: TObject);
        ...
        procedure Edit_Cta_Bco_Descripcion_ProvinciaChange(Sender: TObject);
        procedure Edit_Descripcion_ActividadChange(Sender: TObject);
        procedure Edit_Descripcion_ActividadClick(Sender: TObject);
        procedure Edit_Descripcion_Cliente_TipoChange(Sender: TObject);
        procedure Edit_Descripcion_Forma_PagoChange(Sender: TObject);
        ...
        procedure DBNavigator_EnviosBeforeAction(Sender: TObject; Button: TDBNavButtonType);
        ...
        procedure TabSheet_DatosAdicionalesContextPopup(Sender: TObject;
...
var
    form_clientes_001: Tform_clientes_001;

implementation

{$R *.lfm}

uses menu, clientes_000, clientes_002, clientes_003;

{ Tform_clientes_001 }

procedure Tform_clientes_001.FormCreate(Sender: TObject);
begin
    // ********************************************************************************************* //
    ...
    // ********************************************************************************************* //
    private_Cta_Ctble_elegida := Trim(form_clientes_000.SQLQuery_Clientes.FieldByName('OT_Cuenta_Contable_cliente_tipo').AsString);
end;

procedure Tform_clientes_001.OKButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := true;
end;

procedure Tform_clientes_001.TabSheet_DatosAdicionalesContextPopup(
  Sender: TObject; MousePos: TPoint; var Handled: Boolean);
begin

end;

procedure Tform_clientes_001.CancelButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := false;
end;

procedure Tform_clientes_001.Comprobar_Resto_Datos_Poblacion(param_id : String);
    ...
    try
        ...
        begin
            ...
            begin
                ...
                begin
                    if Trim(form_clientes_000.SQLQuery_Clientes.FieldByName('Codigo_Postal').AsString) = '' then
                    begin
                        form_clientes_000.SQLQuery_Clientes.FieldByName('Codigo_Postal').AsString := FieldByName('Codigo_Postal').AsString;
                    end;
                end;
            end;
        end;
...
procedure Tform_clientes_001.BitBtn_eMAIL1Click(Sender: TObject);
begin

end;

procedure Tform_clientes_001.no_Tocar;
begin
    ...
    Boton_Elegir_Cliente_Tipo.Enabled                     := False;
    ...
    DBEdit_Riesgo_Autorizado.Enabled                      := False;
    DBEdit_Riesgo_Acumulado.Enabled                       := False;
    ...
    DBCheckBox_Agrupar_Albaranes_SN.Enabled               := False;
    DBCheckBox_Activar_Proximidad_SN.Enabled              := False;
    DBGrid_Envios.Enabled                                 := False;
    DBNavigator_Envios.Enabled                            := False;
    BitBtn_Ver_Situacion_Registro_Envios.Enabled          := False;
end;

procedure Tform_clientes_001.Comprobar_Vencimientos(param_msg : TStrings);
begin
    with form_clientes_000.SQLQuery_Clientes do
    begin
...
procedure Tform_clientes_001.Edit_Cta_Bco_Descripcion_ProvinciaChange(
  Sender: TObject);
begin

end;

procedure Tform_clientes_001.Edit_Descripcion_ActividadChange(Sender: TObject);
begin

end;

procedure Tform_clientes_001.Edit_Descripcion_Cliente_TipoChange(Sender: TObject
  );
begin

end;

procedure Tform_clientes_001.Edit_Descripcion_Forma_PagoChange(Sender: TObject);
begin

end;

procedure Tform_clientes_001.Refrescar_Registros;
begin
    form_clientes_000.Refrescar_Registros_Contactos;
    form_clientes_000.Refrescar_Registros_Envios;
end;

procedure Tform_clientes_001.RadioGroup_BajasClick(Sender: TObject);
begin
    //UTI_TB_Ver_Bajas_SN('um', Memo_Filtros.Lines, RadioGroup_Bajas.ItemIndex);
    Refrescar_Registros;
end;

procedure Tform_clientes_001.BitBtn_eMAILClick(Sender: TObject);
begin
    UTI_GEN_Enviar_eMAIL;
end;

function Tform_clientes_001.Existe_Cliente_Contacto_Ya( param_id,
                                                        param_id_clientes,
...
procedure Tform_clientes_001.DBMemo_Observaciones_ComentariosChange(
  Sender: TObject);
begin

end;

procedure Tform_clientes_001.FormActivate(Sender: TObject);
begin
...
function Tform_clientes_001.Comprobar_No_Tocar( param_Reproducir_Mensajes,
...
procedure Tform_clientes_001.Insertar_Registro_Contactos;
var var_msg           : TStrings;
    var_Form          : Tform_clientes_002;
...
begin
    ...
    with form_clientes_000.SQLQuery_Clientes_Contactos do
    begin
        ...
        begin
            if public_Solo_Ver = True then
                ...
                begin
                    ...
                    FieldByName('id_clientes').AsString := form_clientes_000.SQLQuery_Clientes.FieldByName('id').AsString;

                    var_Form := Tform_clientes_002.Create(nil);
                                    ...
                                    if var_record_Existe.Existe = false then
                                        begin
                                            ...
                                            UTI_RGTRO_Grabar_Antes( 'clientes_contactos',
                                                                    form_clientes_000.SQLQuery_Clientes_Contactos );
                                        end
                                    else
                                        begin
                                            Cancel;
                                            ...
                                            var_msg.Add( 'Contacto repetido para este cliente.');
...
procedure Tform_clientes_001.Insertar_Registro_Envios;
var var_msg  : TStrings;
    var_Form : Tform_clientes_003;
begin
    if Comprobar_No_Tocar(true, false) = true then
    begin
        Exit;
        ...
        begin
            if public_Solo_Ver = True then
                ...
                begin
                    ...
                    var_Form := Tform_clientes_003.Create(nil);
                    ...
                    if var_Form.public_Pulso_Aceptar = true then
                        begin
                            ...
                            UTI_RGTRO_Grabar_Antes( 'clientes_envios',
                                                    form_clientes_000.SQLQuery_Clientes_Envios );
                        end
                    else
                        begin
                            var_Form.Free;
...
procedure Tform_clientes_001.Editar_Registro_Envios;
var var_msg  : TStrings;
    var_Form : Tform_clientes_003;
    var_id   : ShortString;
begin
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                if var_Form.public_Pulso_Aceptar = true then
                begin
                    if UTI_DATOS_TABLA_SeCambioAlgoEnRgtro( form_clientes_000.SQLQuery_Clientes_Envios ) = true then
                    begin
                ...
                UTI_RGTRO_UnLock( 'clientes_envios',
                                  var_id );
            end;
        end else begin
...
procedure Tform_clientes_001.Editar_Registro_Contactos;
var var_msg           : TStrings;
    var_Form          : Tform_clientes_002;
    var_record_Existe : Trecord_Existe;
    var_id            : ShortString;
            ...
            begin
                ...
                begin
                    ...
                    begin
                        ...
                        if var_record_Existe.Existe = false then
                        begin
                            if UTI_DATOS_TABLA_SeCambioAlgoEnRgtro( form_clientes_000.SQLQuery_Clientes_Contactos ) = true then
                            begin
                                FieldByName('Change_WHEN').Value    := UTI_CN_Fecha_Hora;
                                FieldByName('Change_Id_User').Value := Form_Menu.public_User;
...
procedure Tform_clientes_001.Borrar_Registro_Contactos;
begin
    if Comprobar_No_Tocar(true, false) = true then
    begin
        Exit;
...
procedure Tform_clientes_001.Borrar_Registro_Envios;
begin
    if Comprobar_No_Tocar(true, false) = true then
    begin
        Exit;
...
procedure Tform_clientes_001.Comprobar_Toda_Fecha_Hora( param_msg : TStrings );
var var_msg : TStrings;
begin
...
procedure Tform_clientes_001.Actualizar_Campos_Fecha_Hora_Si_Completado( param_msg : TStrings );
...
procedure Tform_clientes_001.FormClose(Sender: TObject; var CloseAction: TCloseAction);
var var_msg   : TStrings;
    var_msg_1 : TStrings;
begin
    ...
    begin
        ...
        begin
            ...
            begin
                var_msg.Add( '* El RIESGO AUTORIZADO, bajo DATOS COMERCIALES.');
            end;

            if Trim(FieldByName('Riesgo_Acumulado').AsString) = '' then
            begin
                var_msg.Add( '* El RIESGO ACUMULADO, bajo DATOS COMERCIALES.');
            end;

            if Trim(FieldByName('Agrupar_Albaranes_SN').AsString) = '' then
            begin
                var_msg.Add( '* AGRUPAR ALBARANES para la facturación, bajo DATOS COMERCIALES.');
            end;

            if Trim(FieldByName('Activar_Proximidad_SN').AsString) = '' then
            begin
                var_msg.Add( '* ACTIVAR PROXIMIDAD, bajo DATOS COMERCIALES.');
            end;
            ...
            begin
                ...
                begin
                    var_msg.Add( '* La TARIFA a aplicar, bajo DATOS COMERCIALES.');
                end else begin
                    var_msg_1.Add( '* La TARIFA a aplicar, bajo DATOS COMERCIALES.');
                end;
            end;
            ...
            begin
                ...
                begin
                    ...
                    var_msg_1.Add( '* La forma de pago.');
                end;
            end;
            ...
            begin
                ...
                begin
                    var_msg.Add( '* El tipo de cliente.');
                end else begin
                    var_msg_1.Add( '* El tipo de cliente.');
                end;
            end;
            ...
            begin
                ...
                UTI_CONTA_esta_NIF_BIEN( form_menu.public_User_Configuracion.Clientes_Obligar_NIF_SN,  //.... aqui tambien permitir el control de exigirlo o no
                                         var_msg,
                                         form_clientes_000.SQLQuery_Clientes,
                                         'clientes' );
            end;
            ...
            begin
                if Trim(FieldByName('nif_cif').AsString) = '' then
                begin
                    var_msg_1.Add( '* La CUENTA CONTABLE.');
                end;
            end else begin
    ...
    begin
      ...
      { ********************************************************************
        ...
        ******************************************************************** }
        if public_Pulso_Aceptar = true then
        begin
            if Trim(var_msg_1.Text) <> '' then
            begin
                UTI_GEN_Aviso(false, var_msg_1, 'SOLO DE AVISO.-', True, False);
...
procedure Tform_clientes_001.para_Empezar;
begin
  { ****************************************************************************
    Solo para formularios que traten con datos
    **************************************************************************** }
...
procedure Tform_clientes_001.Presentar_Datos;
var var_Hora : tTime;
    var_Dia  : tDate;
begin
    with form_clientes_000.SQLQuery_Clientes do
...
procedure Tform_clientes_001.Boton_Elegir_PoblacionClick(Sender: TObject);
...
procedure Tform_clientes_001.Boton_Elegir_ProvinciaClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_clientes_000.SQLQuery_Clientes do
    begin
...
procedure Tform_clientes_001.Boton_Elegir_PaisClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_clientes_000.SQLQuery_Clientes do
    begin
...
procedure Tform_clientes_001.BitBtn_SMSClick(Sender: TObject);
begin
    UTI_GEN_Enviar_SMS;
end;

procedure Tform_clientes_001.DBGrid_ContactosDblClick(Sender: TObject);
begin
    Editar_Registro_Contactos;
end;

procedure Tform_clientes_001.DBGrid_ContactosDrawColumnCell(Sender: TObject; const Rect: TRect;
    DataCol: Integer; Column: TColumn; State: TGridDrawState);
var var_Color_Normal : TColor;
begin
    with Sender as TDBGrid do
    begin
        if form_clientes_000.SQLQuery_Clientes_Contactos.RecordCount = 0 then Exit;
      ...
      { ************************************************************************
        ...
        ************************************************************************ }
        if not form_clientes_000.SQLQuery_Clientes_Contactos.FieldByName('Del_WHEN').IsNull then
            begin
              { ****************************************************************
            ...
            begin
              { ****************************************************************
                ...
                **************************************************************** }
                ...
                begin
                    {
                    if Trim(form_clientes_000.SQLQuery_Clientes_Contactos.FieldByName('id_medio').asString) = '1' then
                    begin
...
procedure Tform_clientes_001.DBGrid_ContactosKeyDown(Sender: TObject; var Key: Word;
    Shift: TShiftState);
begin
    if Key = 13 then Editar_Registro_Contactos;
end;

procedure Tform_clientes_001.Edit_Descripcion_PoblacionClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    begin
         form_clientes_000.SQLQuery_Clientes.FieldByName('id_poblaciones').Clear;
         Edit_Descripcion_Poblacion.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_clientes_001.Edit_Descripcion_ProvinciaClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_clientes_000.SQLQuery_Clientes.FieldByName('id_provincias').Clear;
         Edit_Descripcion_Provincia.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_clientes_001.Edit_Descripcion_PaisClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_clientes_000.SQLQuery_Clientes.FieldByName('id_paises').Clear;
         Edit_Descripcion_Pais.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_clientes_001.Boton_Elegir_Cliente_TipoClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_clientes_000.SQLQuery_Clientes do
    begin
...
procedure Tform_clientes_001.Boton_Elegir_RepresentanteClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_clientes_000.SQLQuery_Clientes do
    begin
...
procedure Tform_clientes_001.Boton_Elegir_RutaClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_clientes_000.SQLQuery_Clientes do
    begin
...
procedure Tform_clientes_001.Boton_Elegir_ActividadClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_clientes_000.SQLQuery_Clientes do
    begin
...
procedure Tform_clientes_001.Edit_Descripcion_Cliente_TipoClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_clientes_000.SQLQuery_Clientes.FieldByName('id_clientes_tipos').Clear;
...
procedure Tform_clientes_001.Edit_Descripcion_RepresentanteClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_clientes_000.SQLQuery_Clientes.FieldByName('id_Representantes').Clear;
         Edit_Descripcion_Representante.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_clientes_001.Edit_Descripcion_RutaClick(
  Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_clientes_000.SQLQuery_Clientes.FieldByName('id_rutas').Clear;
         Edit_Descripcion_Ruta.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_clientes_001.Edit_Descripcion_ActividadClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_clientes_000.SQLQuery_Clientes.FieldByName('id_actividades').Clear;
         Edit_Descripcion_Actividad.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_clientes_001.Boton_Elegir_Cta_Bco_PoblacionClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_clientes_000.SQLQuery_Clientes do
    begin
...
procedure Tform_clientes_001.Edit_Cta_Bco_Descripcion_PoblacionClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_clientes_000.SQLQuery_Clientes.FieldByName('id_Cta_Bco_poblaciones').Clear;
         Edit_Cta_Bco_Descripcion_Poblacion.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_clientes_001.Boton_Elegir_Cta_Bco_ProvinciaClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_clientes_000.SQLQuery_Clientes do
    begin
...
procedure Tform_clientes_001.Edit_Cta_Bco_Descripcion_ProvinciaClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_clientes_000.SQLQuery_Clientes.FieldByName('id_Cta_Bco_provincias').Clear;
         Edit_Cta_Bco_Descripcion_Provincia.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_clientes_001.Boton_Elegir_Cta_Bco_PaisClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_clientes_000.SQLQuery_Clientes do
    begin
...
procedure Tform_clientes_001.Edit_Cta_Bco_Descripcion_PaisClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_clientes_000.SQLQuery_Clientes.FieldByName('id_Cta_Bco_pais').Clear;
         Edit_Cta_Bco_Descripcion_Pais.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_clientes_001.Boton_Elegir_Forma_PagoClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_clientes_000.SQLQuery_Clientes do
    begin
...
procedure Tform_clientes_001.Edit_Descripcion_Forma_PagoClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_clientes_000.SQLQuery_Clientes.FieldByName('id_formas_pago').Clear;
         Edit_Descripcion_Forma_Pago.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_clientes_001.Boton_Elegir_TarifaClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_clientes_000.SQLQuery_Clientes do
    begin
        var_Registro := UTI_Abrir_Form( true, false, '', 90 );
        if var_Registro.id_1 <> '' then
        begin
...
procedure Tform_clientes_001.Edit_Descripcion_TarifaClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_clientes_000.SQLQuery_Clientes.FieldByName('id_tarifas').Clear;
         Edit_Descripcion_Tarifa.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_clientes_001.Boton_Elegir_Agencia_TransporteClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_clientes_000.SQLQuery_Clientes do
    begin
...
procedure Tform_clientes_001.Edit_Descripcion_Agencia_TransporteClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_clientes_000.SQLQuery_Clientes.FieldByName('id_Agencias_Transporte').Clear;
         Edit_Descripcion_Agencia_Transporte.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_clientes_001.DBGrid_EnviosDblClick(Sender: TObject);
begin
    Editar_Registro_Envios;
end;

procedure Tform_clientes_001.DBGrid_EnviosDrawColumnCell(Sender: TObject; const Rect: TRect;
    DataCol: Integer; Column: TColumn; State: TGridDrawState);
var var_Color_Normal : TColor;
begin
    with Sender as TDBGrid do
    begin
        if form_clientes_000.SQLQuery_Clientes_Envios.RecordCount = 0 then Exit;
      ...
      { ************************************************************************
        Primero comprobamos si es un registro dado de baja o no
        ************************************************************************ }
        if not form_clientes_000.SQLQuery_Clientes_Envios.FieldByName('Del_WHEN').IsNull then
            begin
              { ****************************************************************
                Registro DADO de BAJA
                **************************************************************** }
            ...
            begin
              { ****************************************************************
                ...
                **************************************************************** }
                ...
                begin
                    {
                    if Trim(form_clientes_000.SQLQuery_Clientes_Envios.FieldByName('id_medio').asString) = '1' then
                    begin
                        Canvas.StretchDraw(param_Rect, Image_Confirmado.Picture.Graphic);
                    end;
                    }
...
procedure Tform_clientes_001.DBGrid_EnviosKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
    if Key = 13 then Editar_Registro_Envios;
end;

procedure Tform_clientes_001.DBNavigator_ContactosBeforeAction(Sender: TObject;
...
procedure Tform_clientes_001.BitBtn_Ver_Situacion_Registro_ContactosClick(Sender: TObject);
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, '', True) = True then
    begin
        if form_clientes_000.SQLQuery_Clientes_Contactos.RecordCount > 0 then
        begin
            UTI_RGTRO_Ver_Estado_Registro( 'clientes_contactos',
                                           form_clientes_000.SQLQuery_Clientes_Contactos,
                                           form_clientes_000.DataSource_Clientes_Contactos,
                                           DBGrid_Contactos );
        end;
    end;
end;

procedure Tform_clientes_001.DBNavigator_EnviosBeforeAction(Sender: TObject;
    Button: TDBNavButtonType);
begin
    case Button of
        nbInsert : begin
...
procedure Tform_clientes_001.BitBtn_Ver_Situacion_Registro_EnviosClick(Sender: TObject);
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, '', True) = True then
    begin
        if form_clientes_000.SQLQuery_Clientes_Envios.RecordCount > 0 then
        begin
            UTI_RGTRO_Ver_Estado_Registro( 'clientes_envios',
                                           form_clientes_000.SQLQuery_Clientes_Envios,
                                           form_clientes_000.DataSource_Clientes_Envios,
                                           DBGrid_Envios );
        end;
    end;
end;
