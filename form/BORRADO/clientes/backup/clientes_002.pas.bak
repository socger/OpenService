...
uses
    ...
    utilidades_general, utilidades_forms_Filtrar, StdCtrls, DbCtrls, EditBtn, maskedit, db;

type

    { Tform_clientes_002 }

    Tform_clientes_002 = class(TForm)
...
var
    form_clientes_002: Tform_clientes_002;

implementation

{$R *.lfm}

uses menu, clientes_000, clientes_001;
...
procedure Tform_clientes_002.FormCreate(Sender: TObject);
begin
    { ****************************************************************************
...
procedure Tform_clientes_002.para_Empezar;
begin
    // ********************************************************************************************* //
    // ** Solo para formularios que traten con datos                                              ** //
    // ********************************************************************************************* //
...
procedure Tform_clientes_002.FormActivate(Sender: TObject);
begin
...
function Tform_clientes_002.Comprobar_No_Tocar( param_Reproducir_Mensajes,
...
procedure Tform_clientes_002.FormClose(Sender: TObject; var CloseAction: TCloseAction);
...
procedure Tform_clientes_002.Comprobar_Toda_Fecha_Hora( param_msg : TStrings );
var var_msg : TStrings;
begin
...
procedure Tform_clientes_002.Actualizar_Campos_Fecha_Hora_Si_Completado( param_msg : TStrings );
...
procedure Tform_clientes_002.Presentar_Datos;
var var_Hora : tTime;
    var_Dia  : tDate;
begin
    WITH form_clientes_000.SQLQuery_Clientes_Contactos do
...
procedure Tform_clientes_002.OKButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := true;
end;

procedure Tform_clientes_002.Panel_MantenimientoClick(Sender: TObject);
begin
  º
end;

procedure Tform_clientes_002.CancelButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := false;
end;

procedure Tform_clientes_002.BitBtn_SMSClick(Sender: TObject);
begin
    UTI_GEN_Enviar_SMS;
end;

procedure Tform_clientes_002.BitBtn_eMAILClick(Sender: TObject);
begin
    UTI_GEN_Enviar_eMAIL;
end;

procedure Tform_clientes_002.BitBtn_Copiar_Datos_ClienteClick(Sender: TObject);
begin
    with form_clientes_000.SQLQuery_Clientes do
    begin
        form_clientes_000.SQLQuery_Clientes_Contactos.FieldByName('nombre').AsString :=
            FieldByName('nombre_propietario').AsString;

        form_clientes_000.SQLQuery_Clientes_Contactos.FieldByName('nif_cif').AsString :=
            FieldByName('nif_cif').AsString;

        DateEdit_Fecha_Nacimiento.Date := form_clientes_001.DateEdit_Fecha_Nacimiento.Date;

        form_clientes_000.SQLQuery_Clientes_Contactos.FieldByName('eMail').AsString :=
            FieldByName('eMail').AsString;

        form_clientes_000.SQLQuery_Clientes_Contactos.FieldByName('pagina_web').AsString :=
            FieldByName('pagina_web').AsString;

        form_clientes_000.SQLQuery_Clientes_Contactos.FieldByName('Tfno_Fijo_1').AsString :=
            FieldByName('Tfno_Fijo_1').AsString;

        form_clientes_000.SQLQuery_Clientes_Contactos.FieldByName('Tfno_Fijo_2').AsString :=
            FieldByName('Tfno_Fijo_2').AsString;

        form_clientes_000.SQLQuery_Clientes_Contactos.FieldByName('FAX').AsString :=
            FieldByName('FAX').AsString;

        form_clientes_000.SQLQuery_Clientes_Contactos.FieldByName('Movil').AsString :=
...
procedure Tform_clientes_002.no_Tocar;
begin
