...
uses
  ...
  ButtonPanel, ExtDlgs, utilidades_datos_tablas, utilidades_bd,
  variants, utilidades_general, utilidades_rgtro, utilidades_usuarios,
...
begin
  ...
  begin
    // Estan relleandos el desde y el hasta
