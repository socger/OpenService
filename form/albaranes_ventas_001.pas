...
resourcestring
  ...
  rs_FormClose_2 = '* El vehículo.';
  rs_FormClose_3 = '* El almacén.';
  rs_FormClose_4 = '* La empresa.';
  rs_FormClose_5 = '* La fecha.';

  rs_Quitamos_1  = '¿QUITAMOS el VEHICULO?';
  rs_Quitamos_2  = '¿QUITAMOS la EMPRESA?';
  rs_Quitamos_3  = '¿QUITAMOS la FORMA DE PAGO?';
  rs_Quitamos_4  = '¿QUITAMOS el ALMACEN?';

  rs_Boton_Elegir_Agencia_1 = '¿DE DONDE TRAEMOS EL TRANSPORTISTA ...';
  rs_Boton_Elegir_Agencia_2 = 'BUSCAMOS EN LA FICHA DE UN CLIENTE(botón OK)';
  rs_Boton_Elegir_Agencia_3 = 'ó BUSCAMOS EN PROVEEDORES QUE TRANSPORTISTA USAREMOS (botón CANCEL) ?';
  rs_Boton_Elegir_Agencia_4 = 'ELIJA ... ';

  rs_Elegir_Direccion_Envio_Cliente_1 = 'No has elegido todavía ningún cliente para este albarán.';
  rs_Elegir_Direccion_Envio_Cliente_2 = 'AVISAMOS DE ... ';

  rs_Vaciar_Datos_Envio = '¿QUITAMOS los datos de la DIRECCION DE ENVIO?';
  rs_Vaciar_Representante = '¿QUITAMOS los datos del REPRESENTANTE?';

  rs_Vaciar_Datos_Agencia = '¿QUITAMOS los datos de la AGENCIA DE TRANSPORTE?';
  rs_Vaciar_Cliente_Datos = '¿QUITAMOS los datos del CLIENTE?';

  rs_Comprobar_No_Tocar_1 = '* Este albarán pertenece al pedido ';
  rs_Comprobar_No_Tocar_2 = 'No se puede modificar nada de él.';
  rs_Comprobar_No_Tocar_3 = '* Este albarán pertenece a una factura, no se puede modificar nada de él.';
  rs_Comprobar_No_Tocar_4 = '* Es un albarán borrado, no se puede modificar nada de el. Si desea modificarlo, primero hay que darlo de alta anteriormente.';

  rs_Editar_Registro_Detalles_1 = 'Esta línea ya pertenece a la factura ';

  rs_Boton_Elegir_AlmacenClick_1 = 'No se pudo, actualizar el almacén ni a la cabecera, ni a sus líneas de detalle.';

  rs_Borrar_Registro_Detalle_1 = '* Esta línea pertenece a la factura ';
  rs_Borrar_Registro_Detalle_2 = '* NO HAY STOCK SUFICIENTE del artículo: ';
  rs_Borrar_Registro_Detalle_3 = '  En el almacén: ';
  rs_Borrar_Registro_Detalle_4 = '  su stock actual es de ';
  rs_Borrar_Registro_Detalle_5 = '  Así que no puedo volver a dar de alta en albaranes la línea con ';
  rs_Borrar_Registro_Detalle_6 = ' unidades a descontar del stock.';

  rs_Boton_Elegir_ClienteClick_1 = 'ATENTO hay OBSERVACIONES';
  rs_Boton_Elegir_ClienteClick_2 = 'El cliente elegido tiene observaciones y las hemos puesto en';
  rs_Boton_Elegir_ClienteClick_3 = ' las observaciones. Están bajo la lengüeta de COMENTARIOS / OBSERVACIONES.';
  rs_Boton_Elegir_ClienteClick_4 = 'No se pudo, actualizar el cliente ni a la cabecera, ni a sus líneas de detalle.';

  rs_Cambiamos_Almacen_SN_1 = 'Hay líneas de detalle, por lo que no podemos cambiar el almacén. Esta medida se opta para no tener problemas con el stock entre almacenes.';
  rs_Cambiamos_Almacen_SN_2 = 'Existe una solución. Borre todas las líneas de detalle, así devolveremos este stock a dicho almacén.';
  rs_Cambiamos_Almacen_SN_3 = 'Luego cambie el almacén al albarán. Esto hará que a todas sus líneas de detalle borradas se les cambie el almacén.';
  rs_Cambiamos_Almacen_SN_4 = 'Luego vuelva a dar de alta a todas las líneas de detalle que le interese, por lo que el stock de almacén volverá a su justo momento antes de cambiar el almacén.';
  rs_Cambiamos_Almacen_SN_5 = 'Este proceso es más seguro que si lo automatizamos.';

type

  { Tform_albaranes_ventas_001 }

  Tform_albaranes_ventas_001 = class(TForm)
...
var
  form_albaranes_ventas_001: Tform_albaranes_ventas_001;

implementation

{$R *.lfm}

uses menu, albaranes_ventas_000, albaranes_ventas_002, facturas_ventas_000;

{ Tform_albaranes_ventas_001 }

procedure Tform_albaranes_ventas_001.FormCreate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
procedure Tform_albaranes_ventas_001.para_Empezar;
begin
    // ********************************************************************************************* //
    // ** Solo para formularios que traten con datos                                              ** //
    // ********************************************************************************************* //
...
procedure Tform_albaranes_ventas_001.Poner_Total_Lineas_Detalle;
begin
    Label_Ctdad_Rgtros.Caption := IntToStr(form_albaranes_ventas_000.SQLQuery_Alb_Detalles.RecordCount);
end;

procedure Tform_albaranes_ventas_001.Presentar_Datos;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb do
    begin
        ...
        form_albaranes_ventas_000.Presentar_Datos_Totales(1);
    end;
end;

procedure Tform_albaranes_ventas_001.Presentar_Datos_Cliente_Generales;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_ventas_001.Presentar_Datos_Bancarios;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_ventas_001.Presentar_Datos_Comerciales;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_ventas_001.Presentar_Datos_Gestion_Cobro;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_ventas_001.Presentar_Datos_Direccion_de_Envio;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_ventas_001.Presentar_Datos_Agencia_de_Transporte;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_ventas_001.Validacion( param_msg : TStrings );
...
begin
    ...
    begin
        ...
        // ** de las faltas                                                                   ** //
        // ************************************************************************************* //
        if (form_albaranes_ventas_000.SQLQuery_Alb.State = dsInsert) and
           (Trim(param_msg.Text) = '')                                 then
        begin
            // ********************************************************************************* //
            // ** OJITO - Sólo si está creando la CABECERA y no falta nada                    ** //
            // ********************************************************************************* //
            if (Trim(FieldByName('Serie_Albaran').AsString) = '')  and
               (Trim(FieldByName('Numero_Albaran').AsString) = '') then
            begin
                var_msg_2 := TStringList.Create;
                var_Registro_Empresa.id := FieldByName('id_empresas').AsString;

                var_Registro_Empresa := UTI_VENTAS_Devolver_Numeracion_Albaran( var_msg_2,
...
procedure Tform_albaranes_ventas_001.FormClose(Sender: TObject; var CloseAction: TCloseAction);
...
procedure Tform_albaranes_ventas_001.OKButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := true;
end;

procedure Tform_albaranes_ventas_001.CancelButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := false;
end;

procedure Tform_albaranes_ventas_001.no_Tocar;
begin
...
procedure Tform_albaranes_ventas_001.Refrescar_Registros;
begin
    form_albaranes_ventas_000.Refrescar_Registros_Detalles;

    form_albaranes_ventas_000.Presentar_Datos_Totales(1);
end;

procedure Tform_albaranes_ventas_001.RadioGroup_BajasClick(Sender: TObject);
begin
    //UTI_TB_Ver_Bajas_SN('um', Memo_Filtros.Lines, RadioGroup_Bajas.ItemIndex);
    Refrescar_Registros;
end;

procedure Tform_albaranes_ventas_001.BitBtn_Ver_Situacion_Registro_ventas_detallesClick(Sender: TObject);
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, '', True) = True then
    begin
        if form_albaranes_ventas_000.SQLQuery_Alb_Detalles.RecordCount > 0 then
        begin
            UTI_RGTRO_Ver_Estado_Registro( 'albaranes_ventas_detalles',
                                           form_albaranes_ventas_000.SQLQuery_Alb_Detalles,
                                           form_albaranes_ventas_000.DataSource_Alb_Detalles,
                                           DBGrid_Detalles );
        end;
    end;
end;

procedure Tform_albaranes_ventas_001.DBGrid_DetallesDblClick(Sender: TObject);
begin
    Editar_Registro_Detalles;
end;

procedure Tform_albaranes_ventas_001.DBGrid_DetallesDrawColumnCell( Sender: TObject;
                                                                                     const Rect: TRect;
                                                                                     DataCol: Integer;
                                                                                     Column: TColumn;
...
begin
    ...
    begin
        if form_albaranes_ventas_000.SQLQuery_Alb_Detalles.RecordCount = 0 then Exit;
        ...
        // ***************************************************************************************** //
        if not form_albaranes_ventas_000.SQLQuery_Alb_Detalles.FieldByName('Del_WHEN').IsNull then
        begin
            // ********************************************************************************* //
            ...
            begin
                if (Column.FieldName <> 'Factura_SN') then
                begin
        ...
        begin
            ...
            if (Column.FieldName <> 'Convertida_SN')     and
               (Column.FieldName <> 'Cobro_Excluido_SN') then
            begin
                if not form_albaranes_ventas_000.SQLQuery_Alb_Detalles.FieldByName('Serie_Factura').IsNull then
                     Canvas.StretchDraw(Rect, form_albaranes_ventas_000.Image_Convertida.Picture.Graphic)
                else DefaultDrawColumnCell(Rect, DataCol, Column, State);

                if Column.FieldName = 'Cobro_Excluido_SN'  then
                begin
                    if form_albaranes_ventas_000.SQLQuery_Alb_Detalles.FieldByName('Excluido_su_Cobro_SN').Value = 'S' then
                         Canvas.StretchDraw(Rect, form_albaranes_ventas_000.Image_Cobro_Excluido.Picture.Graphic)
                    else DefaultDrawColumnCell(Rect, DataCol, Column, State);
                end;
            end;
        end;
...
procedure Tform_albaranes_ventas_001.DBGrid_DetallesKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
    if Key = 13 then Editar_Registro_Detalles;
end;

procedure Tform_albaranes_ventas_001.DBNavigator_DetallesBeforeAction(
...
procedure Tform_albaranes_ventas_001.Edit_Descripcion_id_VehiculosClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    begin
         form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('id_vehiculos').Clear;
         Edit_Descripcion_id_Vehiculos.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_albaranes_ventas_001.Boton_Elegir_id_VehiculosClick(Sender: TObject);
...
procedure Tform_albaranes_ventas_001.Boton_Elegir_EmpresaClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_ventas_001.Edit_Descripcion_EmpresaClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('id_empresas').Clear;
         Edit_Descripcion_Empresa.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_albaranes_ventas_001.Edit_Descripcion_Forma_PagoClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('id_formas_pago').Clear;
         Edit_Descripcion_Forma_Pago.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_albaranes_ventas_001.Boton_Elegir_Forma_PagoClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_ventas_001.Edit_Descripcion_ClienteClick(Sender: TObject);
begin
    Vaciar_Cliente_Datos;
end;

procedure Tform_albaranes_ventas_001.Edit_Direccion_de_Envio_con_Quien_HablarClick(Sender: TObject);
begin
    Vaciar_Datos_Envio;
end;

procedure Tform_albaranes_ventas_001.Edit_Direccion_de_Envio_Agencia_Transporte_DescripcionClick(Sender: TObject);
begin
    Vaciar_Datos_Agencia_de_Transporte;
end;

procedure Tform_albaranes_ventas_001.Edit_Representante_DescripcionClick(Sender: TObject);
begin
    Vaciar_Representante;
end;

procedure Tform_albaranes_ventas_001.Edit_Descripcion_AlmacenClick(Sender: TObject);
var var_msg : TStrings;
begin
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('id_almacenes').Clear;
         Edit_Descripcion_Almacen.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_albaranes_ventas_001.Boton_Elegir_Agencia_TransporteClick(Sender: TObject);
var var_Registro               : TRecord_Rgtro_Comun;
...
begin
    ...
    begin
        var_msg := TStringList.Create;
        var_msg.Add(rs_Boton_Elegir_Agencia_1);
        var_msg.Add(' ');
        var_msg.Add(rs_Boton_Elegir_Agencia_2);
        var_msg.Add(rs_Boton_Elegir_Agencia_3);

        if UTI_GEN_Aviso(true, var_msg, rs_Boton_Elegir_Agencia_4, True, True) = True then
        begin
            // ************************************************************************************* //
...
procedure Tform_albaranes_ventas_001.Boton_Elegir_RepresentanteClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb do
    begin
...
function Tform_albaranes_ventas_001.Elegir_Direccion_Envio_del_Cliente : TRecord_Rgtro_Comun;
var var_msg : TStrings;
begin
    Result.id_1 := '';

    if Trim(form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('id_clientes').AsString) = '' then
    begin
        var_msg := TStringList.Create;
        var_msg.Add(rs_Elegir_Direccion_Envio_Cliente_1);
        UTI_GEN_Aviso(true, var_msg, rs_Elegir_Direccion_Envio_Cliente_2, True, False);
        var_msg.Free;
        Exit;
    end;
...
procedure Tform_albaranes_ventas_001.Vaciar_Datos_Envio;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
        var_msg := TStringList.Create;
        var_msg.Add(rs_Vaciar_Datos_Envio);
        if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
        begin
            with form_albaranes_ventas_000.SQLQuery_Alb do
            begin
...
procedure Tform_albaranes_ventas_001.Vaciar_Representante;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
        var_msg := TStringList.Create;
        var_msg.Add(rs_Vaciar_Representante);
        if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
        begin
            with form_albaranes_ventas_000.SQLQuery_Alb do
            begin
...
procedure Tform_albaranes_ventas_001.Vaciar_Datos_Agencia_de_Transporte;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
        var_msg := TStringList.Create;
        var_msg.Add(rs_Vaciar_Datos_Agencia);
        if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
        begin
            with form_albaranes_ventas_000.SQLQuery_Alb do
            begin
...
procedure Tform_albaranes_ventas_001.Vaciar_Cliente_Datos;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
        var_msg := TStringList.Create;
        var_msg.Add(rs_Vaciar_Cliente_Datos);
        if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
        begin
            with form_albaranes_ventas_000.SQLQuery_Alb do
            begin
...
procedure Tform_albaranes_ventas_001.FormActivate(Sender: TObject);
begin
    // ********************************************************************************************* //
    // ** Si esta llamado desde otro modulo, le cambiamos el color de fondo                       ** //
    // ********************************************************************************************* //
    If form_albaranes_ventas_000.public_Elegimos = true then
    begin
         with Self do
         begin
              Color := $00B9959C;
...
function Tform_albaranes_ventas_001.Comprobar_No_Tocar( param_Reproducir_Mensajes,
...
begin
    ...
    // ********************************************************************************************* //
    // ** Si el albarán proviene de un pedido no se puede modificar nada de él. Si hay que añadir ** //
    // ** algo pues se crea un nuevo albarán                                                      ** //
    // ********************************************************************************************* //
    if (not form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('Serie_Pedido').IsNull)  or
       (not form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('Numero_Pedido').IsNull) then
    begin
        Result := true;
        if param_Reproducir_Mensajes = true then
        begin
            var_msg.Add( rs_Comprobar_No_Tocar_1 +
                         Trim(form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('Serie_Pedido').AsString) +
                         '/' +
                         Trim(form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('Numero_Pedido').AsString) +
                         '. ' +
                         rs_Comprobar_No_Tocar_2 );
        end;
    ...
    // ********************************************************************************************* //
    // ** Si el albarán pertenece a una factura no se puede modificar nada de él.                 ** //
    // ********************************************************************************************* //
    if (not form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('Serie_Factura').IsNull)  or
       (not form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('Numero_Factura').IsNull) then
    begin
        Result := true;
        if param_Reproducir_Mensajes = true then
        begin
            var_msg.Add( rs_Comprobar_No_Tocar_3 );
        end;
    ...
    // ********************************************************************************************* //
    // ** Si el albarán está borrado, no permitimos hacer nada con el.                            ** //
    // ********************************************************************************************* //
    if not form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('Del_WHEN').IsNull then
    begin
        Result := true;

        if param_Reproducir_Mensajes = true then
        begin
            var_msg.Add( rs_Comprobar_No_Tocar_4 );
        end;
...
procedure Tform_albaranes_ventas_001.Insertar_Registro_Detalles;
var var_msg  : TStrings;
    var_Form : Tform_albaranes_ventas_002;
begin
    ...
    with form_albaranes_ventas_000.SQLQuery_Alb_Detalles do
    begin
        var_msg := TStringList.Create;
        ...
        begin
            ...
            begin
                ...
                // ********************************************************************************* //
                UTI_IMPTOS_Asignar_Impto( form_albaranes_ventas_000.SQLQuery_Alb_Detalles,
                                          'id_impuestos_Ventas' );
                ...
                // ********************************************************************************* //
                FieldByName('id_almacenes').Value := form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('id_almacenes').Value;
                // ********************************************************************************* //

                FieldByName('id_clientes').AsString          := form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('id_clientes').AsString;
                FieldByName('Excluido_su_Cobro_SN').AsString := 'N';
                FieldByName('id_albaranes').AsString         := form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('id').AsString;

                var_Form := Tform_albaranes_ventas_002.Create(nil);
...
procedure Tform_albaranes_ventas_001.Editar_Registro_Detalles;
var var_msg  : TStrings;
    var_Form : Tform_albaranes_ventas_002;
    var_id   : ShortString;
begin
    ...
    begin
        ...
        // ***************************************************************************************** //
        // ** Si la línea ya pertenece a una factura que no se pueda editar                       ** //
        // ***************************************************************************************** //
        if (not FieldByName('Serie_Factura').IsNull)  or
           (not FieldByName('Numero_Factura').IsNull) then
        begin
            var_msg.Add( rs_Editar_Registro_Detalles_1 +
        ...
        begin
            ...
            begin
                ...
                if var_Form.public_Pulso_Aceptar = true then
                begin
                    if UTI_DATOS_TABLA_SeCambioAlgoEnRgtro( form_albaranes_ventas_000.SQLQuery_Alb_Detalles ) = true then
                    begin
                        // ************************************************************************* //
...
procedure Tform_albaranes_ventas_001.Poner_Datos_Representante(param_id : ShortString);
...
procedure Tform_albaranes_ventas_001.Boton_Elegir_AlmacenClick(Sender: TObject);
var var_Registro         : TRecord_Rgtro_Comun;
    var_msg              : TStrings;
...
procedure Tform_albaranes_ventas_001.Borrar_Registro_Detalle;
var var_msg            : TStrings;
...
begin
    ...
    begin
        ...
        begin
            // ***************************************************************************** //
            // ** Si la línea ya pertenece a una factura que no se pueda borrar           ** //
            // ***************************************************************************** //
            if (not FieldByName('Serie_Factura').IsNull)  or
               (not FieldByName('Numero_Factura').IsNull) then
            begin
                var_msg := TStringList.Create;
                var_msg.Add( rs_Borrar_Registro_Detalle_1 +
                             Trim(FieldByName('Serie_Factura').AsString) +
                             '/' +
                             Trim(FieldByName('Numero_Factura').AsString)  );
        ...
        begin
            ...
            begin
                ...
                begin
                    ...
                    var_Stock_Articulo := UTI_STOCK_es_Menor_SN( form_albaranes_ventas_000.SQLQuery_Alb_Detalles,
                                                                 form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('id_almacenes').AsString );

                    if var_Stock_Articulo.STOCK_es_Menor = true then
                    begin
                        var_msg := TStringList.Create;

                        var_msg.Add( rs_Borrar_Registro_Detalle_2 );
                        var_msg.Add( '  ' + Trim(FieldByName('OT_descripcion_articulo').AsString) );
                        var_msg.Add( ' ' );
                        var_msg.Add( rs_Borrar_Registro_Detalle_3 );
                        var_msg.Add( '  ' + Trim(form_albaranes_ventas_000.SQLQuery_Alb.FieldByName('OT_descripcion_almacen').AsString) );
                        var_msg.Add( ' ' );
                        var_msg.Add( rs_Borrar_Registro_Detalle_4 + FloatToStr(var_Stock_Articulo.Stock) );
                        var_msg.Add( ' ' );
                        var_msg.Add( rs_Borrar_Registro_Detalle_5 +
                                      Trim(FieldByName('Unidades').AsString) +
                                      rs_Borrar_Registro_Detalle_6 );
...
function Tform_albaranes_ventas_001.Cambiamos_Almacen_SN : Boolean;
var var_msg : TStrings;
begin
    Result := true;

    if form_albaranes_ventas_000.SQLQuery_Alb_Detalles.Active = false then Exit;

    if form_albaranes_ventas_000.SQLQuery_Alb_Detalles.RecordCount > 0 then
    begin
        var_msg := TStringList.Create;
        var_msg.Add( rs_Cambiamos_Almacen_SN_1 );
        var_msg.Add( ' ');
        var_msg.Add( rs_Cambiamos_Almacen_SN_2 );
        var_msg.Add( rs_Cambiamos_Almacen_SN_3 );
        var_msg.Add( rs_Cambiamos_Almacen_SN_4 );
        var_msg.Add( ' ');
        var_msg.Add( rs_Cambiamos_Almacen_SN_5 );
        UTI_GEN_Aviso(true, var_msg, rs_No_Se_Puede, True, False);
        var_msg.Free;
...
procedure Tform_albaranes_ventas_001.Boton_Elegir_ClienteClick(Sender: TObject);
        ...
        begin
             ...
             begin
                 ...
                 begin
                     ...
                     var_msg := TStringList.Create;
                     var_msg.Add(rs_Boton_Elegir_ClienteClick_1);
                     UTI_GEN_Aviso( true,
                                    var_msg,
                                    rs_Boton_Elegir_ClienteClick_2 + rs_Boton_Elegir_ClienteClick_3 ,
                                    True,
                                    False );
                     var_msg.Free;
                 end;
...
procedure Tform_albaranes_ventas_001.BitBtn_Ver_FacturaClick(Sender: TObject);
var var_msg : TStrings;
begin
    with form_albaranes_ventas_000.SQLQuery_Alb_Detalles do
    begin
        ...
        begin
            var_msg := TStringList.Create;
            var_msg.Add('* Es una línea de detalle que no pertenece a ninguna factura.');
            UTI_GEN_Aviso(true, var_msg, rs_No_Se_Puede, True, False);
            var_msg.Free;
...
procedure Tform_albaranes_ventas_001.BitBtn_ImprimirClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := true;
...
function Tform_albaranes_ventas_001.Traer_Representantes_xID( param_id : ShortString ) : TRepresentantes;
...
function Tform_albaranes_ventas_001.Traer_Proveedores_xID( param_id : ShortString ) : TProveedores;
var var_SQLTransaction : TSQLTransaction;
    var_SQLConnector   : TSQLConnector;
    var_SQLQuery       : TSQLQuery;
begin
...
function Tform_albaranes_ventas_001.Traer_Clientes_xID( param_id : ShortString ) : TClientes;
var var_SQLTransaction : TSQLTransaction;
    var_SQLConnector   : TSQLConnector;
    var_SQLQuery       : TSQLQuery;
begin
...
function Tform_albaranes_ventas_001.Traer_Clientes_Envios_xID( param_id : ShortString ) : TClientes_Envios;
var var_SQLTransaction : TSQLTransaction;
    var_SQLConnector   : TSQLConnector;
    var_SQLQuery       : TSQLQuery;
begin
