...
uses
  ...
  StdCtrls, DbCtrls, ExtCtrls, Buttons, DBGrids, utilidades_forms_Filtrar, utilidades_general;

type

  { Tform_facturas_ventas_007 }

  Tform_facturas_ventas_007 = class(TForm)
...
var
  form_facturas_ventas_007: Tform_facturas_ventas_007;

implementation

{$R *.lfm}

uses menu, facturas_ventas_000, facturas_ventas_001;

{ Tform_facturas_ventas_007 }

procedure Tform_facturas_ventas_007.FormActivate(Sender: TObject);
begin
...
procedure Tform_facturas_ventas_007.FormCreate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
function Tform_facturas_ventas_007.Comprobar_No_Tocar( param_Reproducir_Mensajes,
...
begin
    ...
    // ********************************************************************************************* //
    if not form_facturas_ventas_000.SQLQuery_Ftra_Rcbos.FieldByName('Del_WHEN').IsNull then
    begin
        Result := true;
...
procedure Tform_facturas_ventas_007.para_Empezar;
begin
    // ********************************************************************************************* //
    // ** Solo para formularios que traten con datos                                              ** //
    // ********************************************************************************************* //
...
procedure Tform_facturas_ventas_007.OKButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := true;
end;

procedure Tform_facturas_ventas_007.CancelButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := false;
end;

procedure Tform_facturas_ventas_007.Presentar_Datos;
begin
...
procedure Tform_facturas_ventas_007.FormClose(Sender: TObject; var CloseAction: TCloseAction);
var var_msg             : TStrings;
...
procedure Tform_facturas_ventas_007.no_Tocar;
begin
