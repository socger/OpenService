...
begin
    UTI_RGTROS_guardar_valorCampo_BoforePost( SQLQuery_Formas_Pago );
end;
...
begin
  ...
  begin
    var_SQL_ADD.Clear;
    var_SQL_ADD.Add( 'fp.descripcion LIKE ' + UTI_GEN_Comillas('%' + Trim(Edit_Descripcion.Text) + '%') );
  ...
  Result := UTI_TB_Filtrar( private_Order_By,
                            ...
                            // Update_SQL,
                            UTI_DATOS_TABLA_Rellenar_SQL( SQLQuery_Formas_Pago,
                                                          'formas_pago',
                                                          'u' ),
...
begin
    UTI_RGTROS_guardar_valorCampo_BoforeEdit( SQLQuery_Formas_Pago );
end;
        ...
        if RecordCount > 0 then
            begin
                ...
                begin
                    ...
                    if var_Form.public_Pulso_Aceptar = true then
                        begin
                            if UTI_DATOS_TABLA_SeCambioAlgoEnRgtro( SQLQuery_Formas_Pago ) = true then
                               begin
