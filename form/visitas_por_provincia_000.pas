unit visitas_por_provincia_000;
...
uses
  ...
  ComCtrls, StdCtrls, Buttons, DBGrids, DbCtrls, ExtCtrls, Grids, variants, utilidades_bd,
  utilidades_general, utilidades_rgtro, utilidades_usuarios, utilidades_datos_tablas,
  utilidades_forms_Filtrar;

type

  { Tform_visitas_por_provincia_000 }

  Tform_visitas_por_provincia_000 = class(TForm)
...
var
  form_visitas_por_provincia_000: Tform_visitas_por_provincia_000;

implementation

{$R *.lfm}

uses dm_visitas_por_provincia, menu, visitas_000;

{ Tform_visitas_por_provincia_000 }

procedure Tform_visitas_por_provincia_000.FormCreate(Sender: TObject);
...
procedure Tform_visitas_por_provincia_000.para_Empezar;
begin
    // ********************************************************************************************* //
    // ** Solo para formularios que traten con datos                                              ** //
    // ********************************************************************************************* //
    if UTI_GEN_Form_Abierto_Ya('DataModule_visitas_por_provincia') = False then
    begin
        DataModule_visitas_por_provincia := TDataModule_visitas_por_provincia.Create(Application);
    end;
    ...
    private_Order_By_1[0].Memo_OrderBy := 'pr.descripcion ASC';
...
procedure Tform_visitas_por_provincia_000.RadioGroup_BajasClick(Sender: TObject);
begin
    Refrescar_Registros;
end;

procedure Tform_visitas_por_provincia_000.FormClose(Sender: TObject; var CloseAction: TCloseAction);
begin
...
procedure Tform_visitas_por_provincia_000.FormDestroy(Sender: TObject);
begin
    Cerramos_Tablas;
end;

procedure Tform_visitas_por_provincia_000.Cerramos_Tablas;
begin
    Cerramos_Tablas_Ligadas;

    if UTI_TB_Cerrar( DataModule_visitas_por_provincia.SQLCon_Prov,
                      DataModule_visitas_por_provincia.SQLTran_Prov,
                      SQLQuery_1 ) = false then UTI_GEN_Salir;

    DataModule_visitas_por_provincia.Free;
end;

procedure Tform_visitas_por_provincia_000.Cerramos_Tablas_Ligadas;
begin
    if UTI_TB_Cerrar( DataModule_visitas_por_provincia.SQLCon_Visita,
                      DataModule_visitas_por_provincia.SQLTran_Visita,
                      SQLQuery_2 ) = false then UTI_GEN_Salir;
end;

procedure Tform_visitas_por_provincia_000.SQLQuery_1AfterPost(DataSet: TDataSet);
begin
...
procedure Tform_visitas_por_provincia_000.SQLQuery_2AfterPost(DataSet: TDataSet);
begin
...
procedure Tform_visitas_por_provincia_000.SQLQuery_1BeforeEdit(DataSet: TDataSet);
begin
    UTI_RGTROS_guardar_valorCampo_BoforeEdit( SQLQuery_1 );
end;

procedure Tform_visitas_por_provincia_000.SQLQuery_2BeforeEdit(DataSet: TDataSet);
begin
    UTI_RGTROS_guardar_valorCampo_BoforeEdit( SQLQuery_2 );
end;

procedure Tform_visitas_por_provincia_000.SQLQuery_1BeforePost(DataSet: TDataSet);
begin
    UTI_RGTROS_guardar_valorCampo_BoforePost( SQLQuery_1 );
end;

procedure Tform_visitas_por_provincia_000.SQLQuery_2BeforePost(DataSet: TDataSet);
begin
    UTI_RGTROS_guardar_valorCampo_BoforePost( SQLQuery_2 );
end;

procedure Tform_visitas_por_provincia_000.SQLQuery_1AfterScroll(DataSet: TDataSet);
begin
...
procedure Tform_visitas_por_provincia_000.BitBtn_ImprimirClick(Sender: TObject);
...
procedure Tform_visitas_por_provincia_000.DBNavigator_2BeforeAction(Sender: TObject; Button: TDBNavButtonType);
begin
    // Filtrar_tablas_ligadas('S');
    // Filtrar_tablas_ligadas('N');
    // Filtrar_tablas_ligadas('PTO_S');
...
procedure Tform_visitas_por_provincia_000.DBGrid_2DrawColumnCell( Sender: TObject;
                                                                  const Rect: TRect;
                                                                  DataCol: Integer;
                                                                  Column: TColumn;
...
procedure Tform_visitas_por_provincia_000.DBGrid_1DrawColumnCell( Sender: TObject;
                                                                  const Rect: TRect;
                                                                  DataCol: Integer;
                                                                  Column: TColumn;
                                                                  State: TGridDrawState );
...
procedure Tform_visitas_por_provincia_000.DBGrid_1CellClick(Column: TColumn);
begin
    // Filtrar_tablas_ligadas('S');
    // Filtrar_tablas_ligadas('N');
    // Filtrar_tablas_ligadas('PTO_S');
...
procedure Tform_visitas_por_provincia_000.BitBtn_SALIRClick(Sender: TObject);
begin
...
procedure Tform_visitas_por_provincia_000.DBGrid_2DblClick(Sender: TObject);
begin
    Editar_Registro;
end;

procedure Tform_visitas_por_provincia_000.Presentar_Datos;
begin
     /// guardar por lo que pueda pasar
end;

procedure Tform_visitas_por_provincia_000.BitBtn_Ver_Situacion_Registro_1Click(Sender: TObject);
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, '', True) = True then
    begin
        if SQLQuery_1.RecordCount > 0 then
        begin
            UTI_RGTRO_Ver_Estado_Registro( 'provincias',
                                           SQLQuery_1,
                                           DataSource_1,
                                           DBGrid_1 );
        end;
...
procedure Tform_visitas_por_provincia_000.BitBtn_Ver_Situacion_Registro_2Click(Sender: TObject);
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, '', True) = True then
    begin
...
procedure Tform_visitas_por_provincia_000.Refrescar_Registros;
...
function Tform_visitas_por_provincia_000.Filtrar_Visitas( param_con_Pedido_SN : ShortString;
...
begin
  ...
  Result := UTI_TB_Filtrar( private_Order_By_2,
                            ...
                            DataModule_visitas_por_provincia.SQLTran_Visita,
                            DataModule_visitas_por_provincia.SQLCon_Visita,
                            SQLQuery_2,
...
procedure Tform_visitas_por_provincia_000.Filtrar_Principal_Sin_Preguntar;
begin
    RadioGroup_Bajas.ItemIndex := Filtrar_Principal( false );
end;

function Tform_visitas_por_provincia_000.Filtrar_Principal( param_Cambiamos_Filtro : Boolean ) : ShortInt;
var
...
begin
    ...
    Result := UTI_TB_Filtrar( private_Order_By_1,
                              ...
                              DataModule_visitas_por_provincia.SQLTran_Prov,
                              DataModule_visitas_por_provincia.SQLCon_Prov,
                              SQLQuery_1,
...
procedure Tform_visitas_por_provincia_000.Editar_Registro;
...
procedure Tform_visitas_por_provincia_000.Insertar_Registro;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, '', True) = true then
    begin
       ...
       begin
           ...
           form_visitas_000.public_llamado_desde             := 'form_visitas_por_provincia_000';
...
procedure Tform_visitas_por_provincia_000.Pasar_Filtros_a_Visitas( param_con_Pedido_SN : ShortString;
...
begin
    ...
    // ********************************************************************************************* //
    var_SQL_ADD.Clear;
    var_SQL_ADD.Add( 'c.id_provincias = ' + SQLQuery_1.FieldByName('id').AsString );
    UTI_TB_SQL_ADD( true,
                    param_Lineas_Filtro,
                    var_SQL_ADD );
...
procedure Tform_visitas_por_provincia_000.Filtrar_tablas_ligadas(param_con_Pedido_SN : ShortString);
...
procedure Tform_visitas_por_provincia_000.Refrescar_Registros_Detalles(param_con_Pedido_SN : ShortString);
var var_Lineas_Filtro  : TStrings;
    var_Lineas_OrderBy : TStrings;
...
procedure Tform_visitas_por_provincia_000.Boton_Elegir_ClienteClick(Sender: TObject);
...
procedure Tform_visitas_por_provincia_000.Boton_Elegir_Tipo_ClienteClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
...
procedure Tform_visitas_por_provincia_000.Boton_Elegir_Visita_TipoClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
...
procedure Tform_visitas_por_provincia_000.DBGrid_2KeyDown(Sender: TObject;
...
procedure Tform_visitas_por_provincia_000.DBGrid_2KeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
...
procedure Tform_visitas_por_provincia_000.DBNavigator_1BeforeAction(
...
procedure Tform_visitas_por_provincia_000.Boton_Elegir_Visita_ResultadoClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
...
procedure Tform_visitas_por_provincia_000.Boton_Elegir_RutaClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
...
procedure Tform_visitas_por_provincia_000.Boton_Elegir_ActividadClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
...
procedure Tform_visitas_por_provincia_000.Boton_Elegir_RepresentanteClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
...
procedure Tform_visitas_por_provincia_000.Edit_Descripcion_ClienteClick(Sender: TObject);
begin
    Edit_id_Cliente.Text          := '';
    Edit_Descripcion_Cliente.Text := '';
end;

procedure Tform_visitas_por_provincia_000.Edit_Descripcion_Tipo_ClienteClick(Sender: TObject);
begin
    Edit_id_Tipo_Cliente.Text          := '';
    Edit_Descripcion_Tipo_Cliente.Text := '';
end;

procedure Tform_visitas_por_provincia_000.Edit_Descripcion_Visita_TipoClick(Sender: TObject);
begin
    Edit_id_Visita_Tipo.Text          := '';
    Edit_Descripcion_Visita_Tipo.Text := '';
end;

procedure Tform_visitas_por_provincia_000.Edit_Descripcion_Visita_ResultadoClick(Sender: TObject);
begin
    Edit_id_Visita_Resultado.Text          := '';
    Edit_Descripcion_Visita_Resultado.Text := '';
end;

procedure Tform_visitas_por_provincia_000.Edit_Descripcion_RutaClick(Sender: TObject);
begin
    Edit_id_Ruta.Text          := '';
    Edit_Descripcion_Ruta.Text := '';
end;

procedure Tform_visitas_por_provincia_000.Edit_Descripcion_ActividadClick(Sender: TObject);
begin
    Edit_id_Actividad.Text          := '';
    Edit_Descripcion_Actividad.Text := '';
end;

procedure Tform_visitas_por_provincia_000.Edit_Descripcion_RepresentanteClick(Sender: TObject);
begin
    Edit_id_representantes.Text         := '';
    Edit_Descripcion_Representante.Text := '';
end;

procedure Tform_visitas_por_provincia_000.BitBtn_FiltrarClick(Sender: TObject);
var var_msg : TStrings;
begin
    // ********************************************************************************************* //
...
procedure Tform_visitas_por_provincia_000.BitBtn_ver_PedidosClick(Sender: TObject);
begin
    UTI_Abrir_Modulo_PedidosVentas( true, false, '1' );
end;

procedure Tform_visitas_por_provincia_000.BitBtn_ver_PresupuestosClick(Sender: TObject);
begin
