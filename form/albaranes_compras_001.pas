...
uses
  ...
  ExtCtrls, StdCtrls, DbCtrls, Buttons, ComCtrls, DBGrids, LCLTranslator, Grids, utilidades_compras,
  utilidades_datos_tablas, utilidades_forms_Filtrar, utilidades_general, utilidades_usuarios, sqldb,
  utilidades_impuestos, utilidades_rgtro, utilidades_bd;

resourcestring
  rs_FormClose_1 = '* El Proveedor/acreedor.';
  rs_FormClose_3 = '* El almacén.';
  rs_FormClose_4 = '* La empresa.';
  rs_FormClose_5 = '* La fecha de entrada.';
  ...
  rs_Comprobar_No_Tocar_1 = '* Este albarán pertenece al pedido con nuestra referencia ';
  ...
  rs_Editar_Registro_Detalles_1 = 'Esta línea ya pertenece a la factura con nuestra referencia ';

  rs_Boton_Elegir_AlmacenClick_1 = 'No se pudo, actualizar el almacén ni a la cabecera, ni a sus líneas de detalle.';

  rs_Borrar_Registro_Detalle_1 = '* Esta línea pertenece a la factura con nuestra referencia ';
...
type
  ...
  { Tform_albaranes_compras_001 }

  Tform_albaranes_compras_001 = class(TForm)
    BitBtn_SMS: TBitBtn;
    BitBtn_SMS2: TBitBtn;
...
var
  form_albaranes_compras_001: Tform_albaranes_compras_001;

implementation

{$R *.lfm}

uses menu, albaranes_compras_000, proveedores_003, albaranes_compras_002, facturas_compras_000;

{ Tform_albaranes_compras_001 }

procedure Tform_albaranes_compras_001.FormActivate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
procedure Tform_albaranes_compras_001.FormCreate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
procedure Tform_albaranes_compras_001.para_Empezar;
begin
    // ********************************************************************************************* //
    // ** Solo para formularios que traten con datos                                              ** //
    // ********************************************************************************************* //
...
procedure Tform_albaranes_compras_001.Poner_Total_Lineas_Detalle;
begin
    Label_Ctdad_Rgtros.Caption := IntToStr(form_albaranes_compras_000.SQLQuery_Alb_Detalles.RecordCount);
end;

procedure Tform_albaranes_compras_001.Presentar_Datos;
begin
    with form_albaranes_compras_000.SQLQuery_Alb do
    begin
        ...
        form_albaranes_compras_000.Presentar_Datos_Totales(1);
    end;
end;

procedure Tform_albaranes_compras_001.Presentar_Datos_Proveedor_Generales;
begin
    with form_albaranes_compras_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_compras_001.Presentar_Datos_Bancarios;
begin
    with form_albaranes_compras_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_compras_001.Presentar_Datos_Comerciales;
begin
    with form_albaranes_compras_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_compras_001.Presentar_Datos_Gestion_Cobro;
begin
    with form_albaranes_compras_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_compras_001.Presentar_Datos_Direccion_de_Envio;
begin
    with form_albaranes_compras_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_compras_001.Presentar_Datos_Agencia_de_Transporte;
begin
    with form_albaranes_compras_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_compras_001.Validacion( param_msg : TStrings );
...
begin
    ...
    begin
        ...
        // ************************************************************************************* //
        if Trim(FieldByName('Fecha_Albaran_Proveedor').AsString) = '' then
        begin
            param_msg.Add( '* Su fecha de albarán.');
        end;

        if Trim(FieldByName('Numero_Albaran_Proveedor').AsString) = '' then
        begin
            param_msg.Add( '* Su número de albarán.');
        end;
        ...
        // ** de las faltas                                                                   ** //
        // ************************************************************************************* //
        if (form_albaranes_compras_000.SQLQuery_Alb.State = dsInsert) and
        ...
        begin
            ...
            begin
                ...
                var_Registro_Empresa := UTI_COMPRAS_Devolver_Numeracion_Albaran( var_msg_2,
...
procedure Tform_albaranes_compras_001.FormClose(Sender: TObject; var CloseAction: TCloseAction);
...
procedure Tform_albaranes_compras_001.OKButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := true;
end;

procedure Tform_albaranes_compras_001.CancelButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := false;
end;

procedure Tform_albaranes_compras_001.no_Tocar;
begin
    DBDateTimePicker_Fecha.Enabled             := false;
    DBDateTimePicker_Fecha_Albaran.Enabled     := false;
    DBEdit_Numero_Albaran.Enabled              := false;
...
procedure Tform_albaranes_compras_001.Refrescar_Registros;
begin
    form_albaranes_compras_000.Refrescar_Registros_Detalles;

    form_albaranes_compras_000.Presentar_Datos_Totales(1);
end;

procedure Tform_albaranes_compras_001.RadioGroup_BajasClick(Sender: TObject);
begin
    //UTI_TB_Ver_Bajas_SN('um', Memo_Filtros.Lines, RadioGroup_Bajas.ItemIndex);
    Refrescar_Registros;
end;

procedure Tform_albaranes_compras_001.BitBtn_Ver_Situacion_Registro_compras_detallesClick(Sender: TObject);
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, '', True) = True then
    begin
        if form_albaranes_compras_000.SQLQuery_Alb_Detalles.RecordCount > 0 then
        begin
            UTI_RGTRO_Ver_Estado_Registro( 'albaranes_compras_detalles',
                                           form_albaranes_compras_000.SQLQuery_Alb_Detalles,
                                           form_albaranes_compras_000.DataSource_Alb_Detalles,
                                           DBGrid_Detalles );
        end;
    end;
end;

procedure Tform_albaranes_compras_001.DBGrid_DetallesDblClick(Sender: TObject);
begin
    Editar_Registro_Detalles;
end;

procedure Tform_albaranes_compras_001.DBGrid_DetallesDrawColumnCell( Sender: TObject;
                                                                     const Rect: TRect;
                                                                     DataCol: Integer;
                                                                     Column: TColumn;
...
begin
    ...
    begin
        if form_albaranes_compras_000.SQLQuery_Alb_Detalles.RecordCount = 0 then Exit;
        ...
        begin
            ...
            if (Column.FieldName <> 'Convertida_SN')     and
               (Column.FieldName <> 'Cobro_Excluido_SN') then
            begin
                if not form_albaranes_compras_000.SQLQuery_Alb_Detalles.FieldByName('Serie_Factura').IsNull then
                     Canvas.StretchDraw(Rect, form_albaranes_compras_000.Image_Convertida.Picture.Graphic)
                else DefaultDrawColumnCell(Rect, DataCol, Column, State);
            end;

            if Column.FieldName = 'Cobro_Excluido_SN'  then
            begin
                if form_albaranes_compras_000.SQLQuery_Alb_Detalles.FieldByName('Excluido_su_Cobro_SN').Value = 'S' then
                     Canvas.StretchDraw(Rect, form_albaranes_compras_000.Image_Cobro_Excluido.Picture.Graphic)
                else DefaultDrawColumnCell(Rect, DataCol, Column, State);
            end;
        end;
...
procedure Tform_albaranes_compras_001.DBGrid_DetallesKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
    if Key = 13 then Editar_Registro_Detalles;
end;

procedure Tform_albaranes_compras_001.DBNavigator_DetallesBeforeAction(Sender: TObject; Button: TDBNavButtonType);
begin
    case Button of
        nbInsert : begin
...
function Tform_albaranes_compras_001.Traer_Empresas_xID( param_id : ShortString ) : TEmpresas;
...
procedure Tform_albaranes_compras_001.Boton_Elegir_EmpresaClick(Sender: TObject);
...
procedure Tform_albaranes_compras_001.Edit_Descripcion_EmpresaClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    begin
         form_albaranes_compras_000.SQLQuery_Alb.FieldByName('id_empresas').Clear;
         Edit_Descripcion_Empresa.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_albaranes_compras_001.Boton_Elegir_AlmacenClick(Sender: TObject);
var var_Registro         : TRecord_Rgtro_Comun;
    var_msg              : TStrings;
...
procedure Tform_albaranes_compras_001.Edit_Descripcion_AlmacenClick(Sender: TObject);
var var_msg : TStrings;
begin
    if Cambiamos_Almacen_SN = false then Exit;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_albaranes_compras_000.SQLQuery_Alb.FieldByName('id_almacenes').Clear;
         Edit_Descripcion_Almacen.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_albaranes_compras_001.Boton_Elegir_ProveedorClick(Sender: TObject);
...
procedure Tform_albaranes_compras_001.Edit_Descripcion_ProveedorClick(Sender: TObject);
begin
    if Cambiamos_Proveedor_SN = false then Exit;
...
procedure Tform_albaranes_compras_001.Boton_Elegir_Forma_PagoClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_albaranes_compras_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_compras_001.Edit_Descripcion_Forma_PagoClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_albaranes_compras_000.SQLQuery_Alb.FieldByName('id_formas_pago').Clear;
         Edit_Descripcion_Forma_Pago.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_albaranes_compras_001.Boton_Elegir_Contacto_ProveedorClick(Sender: TObject);
var var_Registro          : TRecord_Rgtro_Comun;
...
procedure Tform_albaranes_compras_001.Edit_Direccion_de_Envio_con_Quien_HablarClick(Sender: TObject);
begin
    Vaciar_Datos_Envio;
end;

procedure Tform_albaranes_compras_001.Vaciar_Datos_Envio;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
...
procedure Tform_albaranes_compras_001.Boton_Elegir_Agencia_TransporteClick(Sender: TObject);
var var_Registro               : TRecord_Rgtro_Comun;
...
procedure Tform_albaranes_compras_001.Edit_Direccion_de_Envio_Agencia_Transporte_DescripcionClick(Sender: TObject);
begin
    Vaciar_Datos_Agencia_de_Transporte;
end;

procedure Tform_albaranes_compras_001.Vaciar_Datos_Agencia_de_Transporte;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
...
function Tform_albaranes_compras_001.Elegir_Contacto_del_Proveedor : TRecord_Rgtro_Comun;
var var_msg : TStrings;
begin
    Result.id_1 := '';

    if Trim(form_albaranes_compras_000.SQLQuery_Alb.FieldByName('id_proveedores').AsString) = '' then
    begin
        var_msg := TStringList.Create;
        var_msg.Add('No has elegido todavía ningún proveedor/acreedor para este albarán.');
    ...
    begin
        ...
        form_proveedores_003.Edit_id.Text       := form_albaranes_compras_000.SQLQuery_Alb.FieldByName('id_proveedores').AsString;
...
procedure Tform_albaranes_compras_001.Vaciar_Proveedor_Datos;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
...
function Tform_albaranes_compras_001.Comprobar_No_Tocar( param_Reproducir_Mensajes,
...
begin
    ...
    // ********************************************************************************************* //
    if (not form_albaranes_compras_000.SQLQuery_Alb.FieldByName('Serie_Pedido').IsNull)  or
       (not form_albaranes_compras_000.SQLQuery_Alb.FieldByName('Numero_Pedido').IsNull) then
    begin
        Result := true;
        if param_Reproducir_Mensajes = true then
        begin
            var_msg.Add( rs_Comprobar_No_Tocar_1 +
                         Trim(form_albaranes_compras_000.SQLQuery_Alb.FieldByName('Serie_Pedido').AsString) +
                         '/' +
                         Trim(form_albaranes_compras_000.SQLQuery_Alb.FieldByName('Numero_Pedido').AsString) +
                         '. ' +
    ...
    // ********************************************************************************************* //
    if (not form_albaranes_compras_000.SQLQuery_Alb.FieldByName('Serie_Factura').IsNull)  or
       (not form_albaranes_compras_000.SQLQuery_Alb.FieldByName('Numero_Factura').IsNull) then
    begin
        Result := true;
        if param_Reproducir_Mensajes = true then
        begin
    ...
    // ********************************************************************************************* //
    if not form_albaranes_compras_000.SQLQuery_Alb.FieldByName('Del_WHEN').IsNull then
    begin
        Result := true;
...
procedure Tform_albaranes_compras_001.Insertar_Registro_Detalles;
var var_msg  : TStrings;
    var_Form : Tform_albaranes_compras_002;
begin
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                // ********************************************************************************* //
                UTI_IMPTOS_Asignar_Impto( form_albaranes_compras_000.SQLQuery_Alb_Detalles,
                ...
                // ********************************************************************************* //
                FieldByName('id_almacenes').Value := form_albaranes_compras_000.SQLQuery_Alb.FieldByName('id_almacenes').Value;
                // ********************************************************************************* //

                FieldByName('id_proveedores').AsString       := form_albaranes_compras_000.SQLQuery_Alb.FieldByName('id_proveedores').AsString;
                FieldByName('Excluido_su_Cobro_SN').AsString := 'N';
                FieldByName('id_albaranes').AsString         := form_albaranes_compras_000.SQLQuery_Alb.FieldByName('id').AsString;

                var_Form := Tform_albaranes_compras_002.Create(nil);
                ...
                begin
                    ...
                    UTI_RGTRO_Grabar_Antes( 'albaranes_compras_detalles',
                                            form_albaranes_compras_000.SQLQuery_Alb_Detalles );
...
procedure Tform_albaranes_compras_001.Editar_Registro_Detalles;
var var_msg  : TStrings;
    var_Form : Tform_albaranes_compras_002;
    var_id   : ShortString;
begin
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                if var_Form.public_Pulso_Aceptar = true then
                begin
                    if UTI_DATOS_TABLA_SeCambioAlgoEnRgtro( form_albaranes_compras_000.SQLQuery_Alb_Detalles ) = true then
                    begin
                        // ************************************************************************* //
                ...
                UTI_RGTRO_UnLock( 'albaranes_compras_detalles', var_id );
            end;
        end else begin
...
procedure Tform_albaranes_compras_001.Borrar_Registro_Detalle;
var var_msg : TStrings;
begin
    if Comprobar_No_Tocar(true, false) = true then
    begin
    ...
    begin
        ...
        // ** Continuamos                                                                         ** //
        // ***************************************************************************************** //
        UTI_RGTRO_Borrar( 'albaranes_compras_detalles',
                          form_albaranes_compras_000.SQLQuery_Alb_Detalles,
                          public_Solo_Ver,
                          public_Menu_Worked );
...
function Tform_albaranes_compras_001.Cambiamos_Almacen_SN : Boolean;
var var_msg : TStrings;
begin
    Result := true;

    if form_albaranes_compras_000.SQLQuery_Alb_Detalles.Active = false then Exit;
...
function Tform_albaranes_compras_001.Cambiamos_Proveedor_SN : Boolean;
...
begin
    ...
    var_Estado_Lineas_Detalle := UTI_COMPRAS_Estado_Lineas_Detalle( form_albaranes_compras_000.SQLQuery_Alb_Detalles,
                                                                    'Serie_Factura',
                                                                    'Numero_Factura' );

    if var_Estado_Lineas_Detalle.Total_Lineas_Sin_Marcar <> form_albaranes_compras_000.SQLQuery_Alb_Detalles.RecordCount then
    begin
        var_msg := TStringList.Create;
        var_msg.Add( 'Hay líneas de detalle que fueron convertidas en albaranes, por lo que no ' +
...
procedure Tform_albaranes_compras_001.BitBtn_Ver_FacturaClick(Sender: TObject);
var var_msg : TStrings;
begin
    with form_albaranes_compras_000.SQLQuery_Alb_Detalles do
    begin
...
procedure Tform_albaranes_compras_001.Boton_Elegir_Pais_EnvioClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_albaranes_compras_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_compras_001.Boton_Elegir_Poblacion_EnvioClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_albaranes_compras_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_compras_001.Boton_Elegir_Provincia_EnvioClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_albaranes_compras_000.SQLQuery_Alb do
    begin
...
procedure Tform_albaranes_compras_001.Edit_Direccion_de_Envio_PaisClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    begin
        Edit_Direccion_de_Envio_Pais.Text := '';
        form_albaranes_compras_000.SQLQuery_Alb.FieldByName('Envio_id_paises').Clear;
        form_albaranes_compras_000.SQLQuery_Alb.FieldByName('OT_Envio_descripcion_pais').Clear;
    end;
    var_msg.Free;
end;

procedure Tform_albaranes_compras_001.Edit_Direccion_de_Envio_PoblacionClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    begin
        Edit_Direccion_de_Envio_Poblacion.Text := '';
        form_albaranes_compras_000.SQLQuery_Alb.FieldByName('Envio_id_poblaciones').Clear;
        form_albaranes_compras_000.SQLQuery_Alb.FieldByName('OT_Envio_descripcion_poblacion').Clear;
    end;
    var_msg.Free;
end;

procedure Tform_albaranes_compras_001.Edit_Direccion_de_Envio_ProvinciaClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    begin
        Edit_Direccion_de_Envio_Provincia.Text := '';
        form_albaranes_compras_000.SQLQuery_Alb.FieldByName('Envio_id_provincias').Clear;
        form_albaranes_compras_000.SQLQuery_Alb.FieldByName('OT_Envio_descripcion_provincia').Clear;
    end;
    var_msg.Free;
end;

function Tform_albaranes_compras_001.Traer_Proveedores_xID( param_id : ShortString ) : TProveedores;
var var_SQLTransaction : TSQLTransaction;
    var_SQLConnector   : TSQLConnector;
    var_SQLQuery       : TSQLQuery;
begin
...
function Tform_albaranes_compras_001.Traer_Proveedores_Contactos_xID( param_id : ShortString ) : TProveedores_Contactos;
var var_SQLTransaction : TSQLTransaction;
    var_SQLConnector   : TSQLConnector;
    var_SQLQuery       : TSQLQuery;
begin
