...
uses
  ...
  utilidades_datos_tablas, utilidades_ventas, utilidades_general, utilidades_usuarios,
  utilidades_clientes, utilidades_impuestos, utilidades_rgtro, utilidades_bd;

type

  { Tform_presupuestos_ventas_001 }

  Tform_presupuestos_ventas_001 = class(TForm)
...
var
  form_presupuestos_ventas_001: Tform_presupuestos_ventas_001;

implementation

{$R *.lfm}

uses menu, presupuestos_ventas_000, presupuestos_ventas_002, pedidos_ventas_000;

{ Tform_presupuestos_ventas_001 }

procedure Tform_presupuestos_ventas_001.FormCreate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
procedure Tform_presupuestos_ventas_001.para_Empezar;
begin
    // ********************************************************************************************* //
    // ** Solo para formularios que traten con datos                                              ** //
    // ********************************************************************************************* //
...
procedure Tform_presupuestos_ventas_001.Poner_Total_Lineas_Detalle;
begin
    Label_Ctdad_Rgtros.Caption := IntToStr(form_presupuestos_ventas_000.SQLQuery_Presup_Detalles.RecordCount);
end;

procedure Tform_presupuestos_ventas_001.Presentar_Datos;
begin
    with form_presupuestos_ventas_000.SQLQuery_Presup do
    begin
        ...
        form_presupuestos_ventas_000.Presentar_Datos_Totales(1);
    end;
end;

procedure Tform_presupuestos_ventas_001.Presentar_Datos_Cliente_Generales;
begin
    with form_presupuestos_ventas_000.SQLQuery_Presup do
    begin
...
procedure Tform_presupuestos_ventas_001.Presentar_Datos_Bancarios;
begin
    with form_presupuestos_ventas_000.SQLQuery_Presup do
    begin
...
procedure Tform_presupuestos_ventas_001.Presentar_Datos_Comerciales;
begin
    with form_presupuestos_ventas_000.SQLQuery_Presup do
    begin
...
procedure Tform_presupuestos_ventas_001.Presentar_Datos_Gestion_Cobro;
begin
    with form_presupuestos_ventas_000.SQLQuery_Presup do
    begin
...
procedure Tform_presupuestos_ventas_001.Presentar_Datos_Direccion_de_Envio;
begin
    with form_presupuestos_ventas_000.SQLQuery_Presup do
    begin
...
procedure Tform_presupuestos_ventas_001.Presentar_Datos_Agencia_de_Transporte;
begin
    with form_presupuestos_ventas_000.SQLQuery_Presup do
    begin
...
procedure Tform_presupuestos_ventas_001.Validacion( param_msg : TStrings );
...
begin
    ...
    begin
        ...
        // ** de las faltas                                                                   ** //
        // ************************************************************************************* //
        if (form_presupuestos_ventas_000.SQLQuery_Presup.State = dsInsert) and
        ...
        begin
            ...
            begin
                ...
                var_Registro_Empresa := UTI_VENTAS_Devolver_Numeracion_Presupuesto( var_msg_2,
                ...
                begin
                    ...
                    // ************************************************************************* //
                     FieldByName('Serie_Presupuesto').AsString  := var_Registro_Empresa.Serie_Presupuesto;
                     FieldByName('Numero_Presupuesto').AsString := var_Registro_Empresa.Numero_Presupuesto;
                end;
...
procedure Tform_presupuestos_ventas_001.FormClose(Sender: TObject; var CloseAction: TCloseAction);
...
procedure Tform_presupuestos_ventas_001.OKButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := true;
end;

procedure Tform_presupuestos_ventas_001.CancelButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := false;
end;

procedure Tform_presupuestos_ventas_001.no_Tocar;
begin
...
procedure Tform_presupuestos_ventas_001.Refrescar_Registros;
begin
    form_presupuestos_ventas_000.Refrescar_Registros_Detalles;

    form_presupuestos_ventas_000.Presentar_Datos_Totales(1);
end;

procedure Tform_presupuestos_ventas_001.RadioGroup_BajasClick(Sender: TObject);
begin
    //UTI_TB_Ver_Bajas_SN('um', Memo_Filtros.Lines, RadioGroup_Bajas.ItemIndex);
    Refrescar_Registros;
end;

procedure Tform_presupuestos_ventas_001.BitBtn_Ver_Situacion_Registro_ventas_detallesClick(Sender: TObject);
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, '', True) = True then
    begin
        if form_presupuestos_ventas_000.SQLQuery_Presup_Detalles.RecordCount > 0 then
        begin
            UTI_RGTRO_Ver_Estado_Registro( 'presupuestos_ventas_detalles',
                                           form_presupuestos_ventas_000.SQLQuery_Presup_Detalles,
                                           form_presupuestos_ventas_000.DataSource_Presup_Detalles,
                                           DBGrid_Detalles );
        end;
    end;
end;

procedure Tform_presupuestos_ventas_001.DBGrid_DetallesDblClick(Sender: TObject);
begin
    Editar_Registro_Detalles;
end;

procedure Tform_presupuestos_ventas_001.DBGrid_DetallesDrawColumnCell( Sender: TObject;
                                                                       const Rect: TRect;
                                                                       DataCol: Integer;
                                                                       Column: TColumn;
...
begin
    ...
    begin
        if form_presupuestos_ventas_000.SQLQuery_Presup_Detalles.RecordCount = 0 then Exit;
        ...
        // ***************************************************************************************** //
        if not form_presupuestos_ventas_000.SQLQuery_Presup_Detalles.FieldByName('Del_WHEN').IsNull then
        begin
            // ************************************************************************************* //
        ...
        begin
            ...
            begin
                if not form_presupuestos_ventas_000.SQLQuery_Presup_Detalles.FieldByName('Serie_Pedido').IsNull then
                     Canvas.StretchDraw(Rect, form_presupuestos_ventas_000.Image_Convertida.Picture.Graphic)
                else DefaultDrawColumnCell(Rect, DataCol, Column, State);
            end;

            if Column.FieldName = 'Cobro_Excluido_SN'  then
            begin
                if form_presupuestos_ventas_000.SQLQuery_Presup_Detalles.FieldByName('Excluido_su_Cobro_SN').Value = 'S' then
                     Canvas.StretchDraw(Rect, form_presupuestos_ventas_000.Image_Cobro_Excluido.Picture.Graphic)
                else DefaultDrawColumnCell(Rect, DataCol, Column, State);
            end;
        end;
...
procedure Tform_presupuestos_ventas_001.DBGrid_DetallesKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
    if Key = 13 then Editar_Registro_Detalles;
end;

procedure Tform_presupuestos_ventas_001.DBNavigator_DetallesBeforeAction( Sender: TObject;
...
procedure Tform_presupuestos_ventas_001.Edit_Descripcion_id_VehiculosClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    begin
         form_presupuestos_ventas_000.SQLQuery_Presup.FieldByName('id_vehiculos').Clear;
         Edit_Descripcion_id_Vehiculos.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_presupuestos_ventas_001.Boton_Elegir_id_VehiculosClick(Sender: TObject);
...
procedure Tform_presupuestos_ventas_001.Boton_Elegir_EmpresaClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_presupuestos_ventas_000.SQLQuery_Presup do
    begin
...
procedure Tform_presupuestos_ventas_001.Edit_Descripcion_EmpresaClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_presupuestos_ventas_000.SQLQuery_Presup.FieldByName('id_empresas').Clear;
         Edit_Descripcion_Empresa.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_presupuestos_ventas_001.Edit_Descripcion_Forma_PagoClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_presupuestos_ventas_000.SQLQuery_Presup.FieldByName('id_formas_pago').Clear;
         Edit_Descripcion_Forma_Pago.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_presupuestos_ventas_001.Boton_Elegir_Forma_PagoClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_presupuestos_ventas_000.SQLQuery_Presup do
    begin
...
procedure Tform_presupuestos_ventas_001.Edit_Descripcion_ClienteClick(Sender: TObject);
begin
...
procedure Tform_presupuestos_ventas_001.Edit_Direccion_de_Envio_con_Quien_HablarClick(Sender: TObject);
begin
    Vaciar_Datos_Envio;
end;

procedure Tform_presupuestos_ventas_001.Edit_Direccion_de_Envio_Agencia_Transporte_DescripcionClick(Sender: TObject);
begin
    Vaciar_Datos_Agencia_de_Transporte;
end;

procedure Tform_presupuestos_ventas_001.Edit_Representante_DescripcionClick(Sender: TObject);
begin
    Vaciar_Representante;
end;

procedure Tform_presupuestos_ventas_001.Edit_Descripcion_AlmacenClick(Sender: TObject);
var var_msg : TStrings;
begin
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_presupuestos_ventas_000.SQLQuery_Presup.FieldByName('id_almacenes').Clear;
         Edit_Descripcion_Almacen.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_presupuestos_ventas_001.Boton_Elegir_Agencia_TransporteClick(Sender: TObject);
var var_Registro               : TRecord_Rgtro_Comun;
...
procedure Tform_presupuestos_ventas_001.Boton_Elegir_RepresentanteClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_presupuestos_ventas_000.SQLQuery_Presup do
    begin
...
function Tform_presupuestos_ventas_001.Elegir_Direccion_Envio_del_Cliente : TRecord_Rgtro_Comun;
var var_msg : TStrings;
begin
    Result.id_1 := '';

    if Trim(form_presupuestos_ventas_000.SQLQuery_Presup.FieldByName('id_clientes').AsString) = '' then
    begin
        var_msg := TStringList.Create;
        var_msg.Add('No has elegido todavía ningún cliente para este presupuesto.');
        UTI_GEN_Aviso(true, var_msg, 'AVISAMOS DE ... ', True, False);
        var_msg.Free;
        Exit;
    end;

    Result := UTI_CLIENTES_Elegir_Direccion_Envio( form_presupuestos_ventas_000.SQLQuery_Presup.FieldByName('id_clientes').AsString,
                                                   public_Menu_Worked );
end;

procedure Tform_presupuestos_ventas_001.Boton_Elegir_Direccion_EnvioClick(Sender: TObject);
var var_Registro       : TRecord_Rgtro_Comun;
...
procedure Tform_presupuestos_ventas_001.Vaciar_Datos_Envio;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
...
procedure Tform_presupuestos_ventas_001.Vaciar_Representante;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
...
procedure Tform_presupuestos_ventas_001.Vaciar_Datos_Agencia_de_Transporte;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
...
procedure Tform_presupuestos_ventas_001.Vaciar_Cliente_Datos;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
...
procedure Tform_presupuestos_ventas_001.FormActivate(Sender: TObject);
begin
    // ********************************************************************************************* //
    // ** Si esta llamado desde otro modulo, le cambiamos el color de fondo                       ** //
    // ********************************************************************************************* //
    If form_presupuestos_ventas_000.public_Elegimos = true then
    begin
        with Self do
        begin
            Color := $00B9959C;
...
function Tform_presupuestos_ventas_001.Comprobar_No_Tocar( param_Reproducir_Mensajes,
...
procedure Tform_presupuestos_ventas_001.Insertar_Registro_Detalles;
var var_msg  : TStrings;
    var_Form : Tform_presupuestos_ventas_002;
begin
    ...
    with form_presupuestos_ventas_000.SQLQuery_Presup_Detalles do
    begin
        var_msg := TStringList.Create;
        ...
        begin
            ...
            begin
                ...
                // ********************************************************************************* //
                UTI_IMPTOS_Asignar_Impto( form_presupuestos_ventas_000.SQLQuery_Presup_Detalles,
                                          'id_impuestos_Ventas' );
                ...
                // ********************************************************************************* //
                FieldByName('id_almacenes').Value := form_presupuestos_ventas_000.SQLQuery_Presup.FieldByName('id_almacenes').Value;
                // ********************************************************************************* //

                FieldByName('id_clientes').AsString          := form_presupuestos_ventas_000.SQLQuery_Presup.FieldByName('id_clientes').AsString;
                FieldByName('Excluido_su_Cobro_SN').AsString := 'N';
                FieldByName('id_presupuestos').AsString      := form_presupuestos_ventas_000.SQLQuery_Presup.FieldByName('id').AsString;

                var_Form := Tform_presupuestos_ventas_002.Create(nil);
                ...
                begin
                    ...
                    UTI_RGTRO_Grabar_Antes( 'presupuestos_ventas_detalles',
                                            form_presupuestos_ventas_000.SQLQuery_Presup_Detalles );
...
procedure Tform_presupuestos_ventas_001.Editar_Registro_Detalles;
var var_msg  : TStrings;
    var_Form : Tform_presupuestos_ventas_002;
    var_id   : ShortString;
begin
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                if var_Form.public_Pulso_Aceptar = true then
                begin
                    if UTI_DATOS_TABLA_SeCambioAlgoEnRgtro( form_presupuestos_ventas_000.SQLQuery_Presup_Detalles ) = true then
                    begin
                        // ************************************************************************* //
...
procedure Tform_presupuestos_ventas_001.Borrar_Registro_Detalle;
var var_msg : TStrings;
begin
    if Comprobar_No_Tocar(true, false) = true then
    begin
    ...
    // ********************************************************************************************* //
    if (not form_presupuestos_ventas_000.SQLQuery_Presup_Detalles.FieldByName('Serie_Pedido').IsNull)  or
       (not form_presupuestos_ventas_000.SQLQuery_Presup_Detalles.FieldByName('Numero_Pedido').IsNull) then
    begin
        var_msg := TStringList.Create;

        var_msg.Add( 'Esta línea pertenece al pedido ' +
                     Trim(form_presupuestos_ventas_000.SQLQuery_Presup_Detalles.FieldByName('Serie_Pedido').AsString) +
                     '/' +
                     Trim(form_presupuestos_ventas_000.SQLQuery_Presup_Detalles.FieldByName('Numero_Pedido').AsString)  );
    ...
    begin
        UTI_RGTRO_Borrar( 'presupuestos_ventas_detalles',
                          form_presupuestos_ventas_000.SQLQuery_Presup_Detalles,
                          public_Solo_Ver,
                          public_Menu_Worked );
...
function Tform_presupuestos_ventas_001.Traer_Representantes_xID( param_id : ShortString ) : TRepresentantes;
...
procedure Tform_presupuestos_ventas_001.Poner_Datos_Representante(param_id : ShortString);
...
procedure Tform_presupuestos_ventas_001.Boton_Elegir_AlmacenClick(Sender: TObject);
var var_Registro         : TRecord_Rgtro_Comun;
    var_msg              : TStrings;
...
function Tform_presupuestos_ventas_001.Cambiamos_Cliente_SN : Boolean;
var var_msg                   : TStrings;
    var_Estado_Lineas_Detalle : TUTI_VENTAS_Ctdad_Rgtros_Detalle;
begin
    Result := true;

    if form_presupuestos_ventas_000.SQLQuery_Presup_Detalles.Active = false then Exit;

    var_Estado_Lineas_Detalle := UTI_VENTAS_Estado_Lineas_Detalle( form_presupuestos_ventas_000.SQLQuery_Presup_Detalles,
                                                                   'Serie_Pedido',
                                                                   'Numero_Pedido' );

    if var_Estado_Lineas_Detalle.Total_Lineas_Sin_Marcar <> form_presupuestos_ventas_000.SQLQuery_Presup_Detalles.RecordCount then
    begin
        var_msg := TStringList.Create;
        var_msg.Add( 'Hay líneas de detalle que fueron convertidas en pedidos, por lo que no ' +
                     'podemos cambiar el cliente.' );
...
function Tform_presupuestos_ventas_001.Cambiamos_Almacen_SN : Boolean;
var var_msg                   : TStrings;
    var_Estado_Lineas_Detalle : TUTI_VENTAS_Ctdad_Rgtros_Detalle;
begin
    Result := true;
...
procedure Tform_presupuestos_ventas_001.Boton_Elegir_ClienteClick(Sender: TObject);
...
procedure Tform_presupuestos_ventas_001.BitBtn_Ver_PedidoClick(Sender: TObject);
var var_msg : TStrings;
begin
    with form_presupuestos_ventas_000.SQLQuery_Presup_Detalles do
    begin
...
procedure Tform_presupuestos_ventas_001.BitBtn_Crear_Linea_como_PedidoClick(Sender: TObject);
...
begin
    ...
    begin
        ...
        var_Registro_Empresa := form_presupuestos_ventas_000.Crear_Pedido_su_Cabecera( var_Fecha );
        ...
        begin
            form_presupuestos_ventas_000.Crear_Pedido_su_Detalle( var_Fecha,
...
function Tform_presupuestos_ventas_001.Comprobar_desde_Detalles_Si_Cerramos_1 : Boolean;
...
procedure Tform_presupuestos_ventas_001.Comprobar_desde_Detalles_Si_Cerramos_0;
begin
    // ********************************************************************************************* //
...
procedure Tform_presupuestos_ventas_001.BitBtn_ImprimirClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := true;
...
function Tform_presupuestos_ventas_001.Traer_Proveedores_xID( param_id : ShortString ) : TProveedores;
var var_SQLTransaction : TSQLTransaction;
    var_SQLConnector   : TSQLConnector;
    var_SQLQuery       : TSQLQuery;
begin
...
function Tform_presupuestos_ventas_001.Traer_Clientes_xID( param_id : ShortString ) : TClientes;
var var_SQLTransaction : TSQLTransaction;
    var_SQLConnector   : TSQLConnector;
    var_SQLQuery       : TSQLQuery;
begin
...
function Tform_presupuestos_ventas_001.Traer_Clientes_Envios_xID( param_id : ShortString ) : TClientes_Envios;
var var_SQLTransaction : TSQLTransaction;
    var_SQLConnector   : TSQLConnector;
    var_SQLQuery       : TSQLQuery;
begin
