...
uses
  ...
  utilidades_impuestos, utilidades_lineas_detalle, utilidades_stock, utilidades_usuarios;

type

  { Tform_facturas_ventas_002 }

  Tform_facturas_ventas_002 = class(TForm)
...
var
  form_facturas_ventas_002: Tform_facturas_ventas_002;

implementation

{$R *.lfm}

uses menu, facturas_ventas_000, facturas_ventas_001, articulos_ultimas_ventas_000;

{ Tform_facturas_ventas_002 }

procedure Tform_facturas_ventas_002.FormActivate(Sender: TObject);
begin
...
procedure Tform_facturas_ventas_002.FormCreate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
function Tform_facturas_ventas_002.Comprobar_No_Tocar( param_Reproducir_Mensajes,
...
procedure Tform_facturas_ventas_002.Boton_Elegir_AlmacenClick(Sender: TObject);
...
procedure Tform_facturas_ventas_002.Edit_Descripcion_AlmacenClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    begin
         form_facturas_ventas_000.SQLQuery_Ftra_Detalles.FieldByName('id_almacenes').Clear;
         Edit_Descripcion_Almacen.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_facturas_ventas_002.Edit_Descripcion_ArticuloClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_facturas_ventas_000.SQLQuery_Ftra_Detalles.FieldByName('id_articulos').Clear;
         form_facturas_ventas_000.SQLQuery_Ftra_Detalles.FieldByName('Repetir_Cada').Clear;
...
procedure Tform_facturas_ventas_002.Boton_Elegir_ImpuestoClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
    var_msg      : TStrings;
begin
    with form_facturas_ventas_000.SQLQuery_Ftra_Detalles do
        ...
        begin
            ...
            begin
                ...
                if UTI_IMPTOS_Existe_el_impto_NOcompuesto_como_compuesto( FieldByName('id_facturas').AsString,
                                                                          var_Registro.id_1,
                                                                          'facturas_ventas_detalles' ) <> '0' then
                begin
                    var_msg := TStringList.Create;
...
procedure Tform_facturas_ventas_002.Edit_Descripcion_ImpuestoClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
...
procedure Tform_facturas_ventas_002.para_Empezar;
begin
    // ********************************************************************************************* //
    // ** Solo para formularios que traten con datos                                              ** //
    // ********************************************************************************************* //
...
procedure Tform_facturas_ventas_002.OKButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := true;
end;

procedure Tform_facturas_ventas_002.CancelButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := false;
end;

procedure Tform_facturas_ventas_002.DBEdit_Descuento_Comercial_1Exit(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_facturas_ventas_002.DBEdit_Descuento_Comercial_2Exit(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_facturas_ventas_002.DBEdit_PVPExit(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_facturas_ventas_002.DBEdit_CtdadExit(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_facturas_ventas_002.Presentar_Datos;
begin
    ...
    begin
        ...
        Edit_Descripcion_Cliente.Text      := form_facturas_ventas_001.Edit_Descripcion_Cliente.Text;
        Edit_Descripcion_Almacen.Text      := form_facturas_ventas_001.Edit_Descripcion_Almacen.Text;
        Edit_Descripcion_Almacen1.Text     := form_facturas_ventas_001.Edit_Descripcion_Almacen.Text;
        Edit_Descripcion_Empresa.Text      := form_facturas_ventas_001.Edit_Descripcion_Empresa.Text;
    end;
...
procedure Tform_facturas_ventas_002.Presentar_Descripcion_en_Amarillo_o_no;
begin
    with form_facturas_ventas_000.SQLQuery_Ftra_Detalles do
    begin
...
procedure Tform_facturas_ventas_002.FormClose(Sender: TObject; var CloseAction: TCloseAction);
var var_msg             : TStrings;
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                begin
                    var_msg.Add( ' ');
                    var_msg.Add( '* Del artículo <<< ' + Trim(Edit_Descripcion_Articulo.Text) +
                                 ' >>>' );

                    var_msg.Add( 'su stock actual en el almacén <<< ' +
                                  Trim(Edit_Descripcion_Almacen1.Text) +
                                  ' >>>' );

                    var_msg.Add( 'es de ' + FloatToStr(var_Stock_Articulo.Stock) +
                                  ', así que no puedo crear la línea con ' +
            ...
            var_almacen := form_facturas_ventas_000.SQLQuery_Ftra.FieldByName('id_almacenes').AsString;
...
procedure Tform_facturas_ventas_002.no_Tocar;
begin
    Panel_Mantenimiento.Enabled := False;
end;

procedure Tform_facturas_ventas_002.DBCheckBox_Estudia_SNChange(Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_facturas_ventas_002.Edit_PVP_Imptos_IncluidosExit(
  Sender: TObject);
begin
    Calcular_Importe_menos_Descuento;
end;

procedure Tform_facturas_ventas_002.Boton_Buscar_Referencia_ArticuloClick(Sender: TObject);
var var_msg      : TStrings;
    var_Devuelve : String;
begin
    var_msg := TStringList.Create;
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                // ********************************************************************************* //
                var_Devuelve := UTI_LINEAS_Buscar_Articulo_por_Referencia( form_facturas_ventas_000.SQLQuery_Ftra_Detalles,
...
procedure Tform_facturas_ventas_002.Boton_Elegir_ArticuloClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_facturas_ventas_000.SQLQuery_Ftra_Detalles do
    begin
        ...
        if var_Registro.id_1 <> '' then
        begin
            Edit_Descripcion_Impuesto.Text := UTI_LINEAS_Traer_Resto_Datos_Articulo( form_facturas_ventas_000.SQLQuery_Ftra_Detalles,
                                                                                     var_Registro.id_1,
                                                                                     true,
                                                                                     '' );
...
procedure Tform_facturas_ventas_002.Calcular_Importe_menos_Descuento;
var var_msg  : TStrings;
    var_Calc : Extended;
begin
    var_msg := TStringList.Create;

    UTI_LINEAS_Controlar_PVP( form_facturas_ventas_000.SQLQuery_Ftra_Detalles,
...
procedure Tform_facturas_ventas_002.Boton_ver_HistoricoClick(Sender: TObject);
var var_msg  : TStrings;
