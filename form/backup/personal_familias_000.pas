...
type
  ...
  Tform_personal_familias_000 = class(TForm)
    ...
    function  Existe_el_Personal_Familia_Ya( param_id, param_descripcion : ShortString ) : Trecord_Existe;
...
function Tform_personal_familias_000.Existe_el_Personal_Familia_Ya( param_id,
    ...
    try
      ...
      { ****************************************************************************
        ...
        **************************************************************************** }
        ...
        var_SQLQuery.Name := 'SQLQuery_Existe_el_Personal_Familia_Ya';
      ...
      { ****************************************************************************
        ...
        **************************************************************************** }
        ...
        var_SQLConnector.Free;
         ...
         begin
             UTI_GEN_Error_Log( 'Error al comprobar si el tipo de artículos existe ya.' +
            ...
            if public_Solo_Ver = True then
                ...
                begin
                    ...
                    if form_personal_familias_001.public_Pulso_Aceptar = true then
                        begin
                            var_record_Existe := Existe_el_Personal_Familia_Ya( '',
        ...
        if RecordCount > 0 then
            begin
                ...
                begin
                    ...
                    if form_personal_familias_001.public_Pulso_Aceptar = true then
                        begin
                            var_record_Existe := Existe_el_Personal_Familia_Ya( FieldByName('id').AsString,
                                                                                FieldByName('descripcion').AsString );
