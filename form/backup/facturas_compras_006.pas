...
uses
  Classes, SysUtils, FileUtil, Forms, Controls, Graphics, Dialogs, Buttons, StdCtrls, DbCtrls,
  DBGrids, Grids, utilidades_general;

type

  { Tform_facturas_compras_006 }

  Tform_facturas_compras_006 = class(TForm)
...
var
  form_facturas_compras_006: Tform_facturas_compras_006;

implementation

{$R *.lfm}

uses menu, facturas_compras_000;

{ Tform_facturas_compras_006 }

procedure Tform_facturas_compras_006.FormActivate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
procedure Tform_facturas_compras_006.FormCreate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
procedure Tform_facturas_compras_006.para_Empezar;
begin
    Presentar_Datos;
end;

procedure Tform_facturas_compras_006.Presentar_Datos;
begin
...
procedure Tform_facturas_compras_006.FormClose(Sender: TObject; var CloseAction: TCloseAction);
begin
...
procedure Tform_facturas_compras_006.BitBtn_SALIRClick(Sender: TObject);
begin
...
procedure Tform_facturas_compras_006.BitBtn_SeleccionarClick(Sender: TObject);
begin
    private_Salir_OK          := true;  { La pongo a true para controlar el modo de BitBtn_SALIR del programa}
...
procedure Tform_facturas_compras_006.DBGrid_PrincipalDblClick(Sender: TObject);
begin
...
procedure Tform_facturas_compras_006.DBGrid_PrincipalDrawColumnCell(
...
begin
    ...
    begin
        ...
        // ***************************************************************************************** //
        if form_facturas_compras_000.SQLQuery_Ftra_Borradas.FieldByName('Tipo').AsString = 'F' then
        begin
            // ************************************************************************************* //
            // ** Es una factura                                                                  ** //
            // ************************************************************************************* //
...
procedure Tform_facturas_compras_006.DBNavigator_DetallesBeforeAction(Sender: TObject; Button: TDBNavButtonType);
begin
    case Button of
        nbRefresh : begin
            form_facturas_compras_000.Refrescar_Registros_Ftras_Borradas;
            Abort;
        end;
    end;
end;
