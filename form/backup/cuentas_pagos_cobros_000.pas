...
type
  ...
  Tform_cuentas_pagos_cobros_000 = class(TForm)
    ...
    ComboBox_Modalidad: TComboBox;
    ComboBox_Tipo_Cuenta: TComboBox;
    ...
    SQLQuery_Cuentas_Pagos_CobrosCuenta_Contable: TStringField;
    ...
    SQLQuery_Cuentas_Pagos_CobrosModalidad: TStringField;
    SQLQuery_Cuentas_Pagos_CobrosOT_Modalidad_Descripcion1: TStringField;
    SQLQuery_Cuentas_Pagos_CobrosOT_Tipo_Cuenta_Descripcion1: TStringField;
    SQLQuery_Cuentas_Pagos_CobrosTipo_Cuenta: TStringField;
...
uses dm_cuentas_pagos_cobros, menu, cuentas_pagos_cobros_001;
...
begin
    UTI_RGTROS_Grabar( 'cuentas_pagos_cobros',
...
begin
     UTI_RGTROS_guardar_valorCampo_BoforePost( SQLQuery_Cuentas_Pagos_Cobros );
end;
...
begin
    ...
    case Button of
        ...
        nbDelete : begin
            ...
            begin
                UTI_RGTRO_Borrar( 'cuentas_pagos_cobros',
                                  SQLQuery_Cuentas_Pagos_Cobros,
                                  public_Solo_Ver,
                                  public_Menu_Worked );
            end;
...
begin
    ...
    var_Ordenado_por := var_Ordenado_por +
                        ', con modalidad = ' +
                        Trim(ComboBox_Modalidad.Text);

    var_Ordenado_por := var_Ordenado_por +
                        ', con tipo de cuenta = ' +
                        Trim(ComboBox_Tipo_Cuenta.Text);
...
begin
    ...
    begin
        var_SQL_ADD.Clear;
        var_SQL_ADD.Add( 'cpc.descripcion LIKE ' + UTI_GEN_Comillas('%' + Trim(Edit_Descripcion.Text) + '%') );
    ...
    // ** Ahora la modalidad                                                                      ** //
    // ********************************************************************************************* //
    if ComboBox_Modalidad.ItemIndex <> 0 then
    begin
        var_SQL_ADD.Clear;
        var_SQL_ADD.Add( 'cpc.Modalidad = ' + IntToStr(ComboBox_Modalidad.ItemIndex) );
        UTI_TB_SQL_ADD( false,
                        var_a_Filtrar,
                        var_SQL_ADD );
    end;
    ...
    // ********************************************************************************************* //
    if ComboBox_Tipo_Cuenta.ItemIndex <> 0 then
    begin
        var_SQL_ADD.Clear;
        var_SQL_ADD.Add( 'cpc.Tipo_Cuenta = ' + IntToStr(ComboBox_Tipo_Cuenta.ItemIndex) );
        UTI_TB_SQL_ADD( false,
                        var_a_Filtrar,
                        var_SQL_ADD );
    end;
    ...
    Result := UTI_TB_Filtrar( private_Order_By,
                              ...
                              // Update_SQL,
                              UTI_DATOS_TABLA_Rellenar_SQL( SQLQuery_Cuentas_Pagos_Cobros,
    ...
    Label_Ctdad_Rgtros.Caption := IntToStr(SQLQuery_Cuentas_Pagos_Cobros.RecordCount);
                ...
                begin
                    ...
                    if var_Form.public_Pulso_Aceptar = true then
                        begin
                            ...
                            UTI_RGTRO_Grabar_Antes( 'cuentas_pagos_cobros',
                                                    SQLQuery_Cuentas_Pagos_Cobros );
                        end
                    else Cancel;
...
begin
    UTI_RGTROS_guardar_valorCampo_BoforeEdit( SQLQuery_Cuentas_Pagos_Cobros );
end;
    ...
    begin
        ...
        if RecordCount > 0 then
            begin
                ...
                begin
                    if UTI_RGTRO_isLock( 'cuentas_pagos_cobros',
                        ...
                        begin
                            if UTI_RGTRO_Lock( 'cuentas_pagos_cobros',
                    ...
                    if var_Form.public_Pulso_Aceptar = true then
                        begin
                            if UTI_DATOS_TABLA_SeCambioAlgoEnRgtro( SQLQuery_Cuentas_Pagos_Cobros ) = true then
                               begin
                    ...
                    UTI_RGTRO_UnLock( 'cuentas_pagos_cobros',
                                      var_id );
                end;
            end
        else
...
procedure Tform_cuentas_pagos_cobros_000.Filtrar_Principal_Sin_Preguntar;
begin
    RadioGroup_Bajas.ItemIndex := Filtrar_Principal( false );
end;

procedure Tform_cuentas_pagos_cobros_000.ComboBox_FiltrosChange(Sender: TObject
  );
begin
