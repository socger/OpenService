...
uses
  Classes, SysUtils, FileUtil, DBDateTimePicker, sqldb, Forms, Controls, Graphics, Dialogs, ButtonPanel,
  ExtCtrls, StdCtrls, DbCtrls, Buttons, ComCtrls, DBGrids, Grids, db, utilidades_forms_Filtrar,
  utilidades_datos_tablas, utilidades_compras, utilidades_general, utilidades_usuarios,
  utilidades_impuestos, utilidades_rgtro, utilidades_bd;

type

  { Tform_pedidos_compras_001 }

  Tform_pedidos_compras_001 = class(TForm)
    ...
    DBDateTimePicker_Fecha_Pedido: TDBDateTimePicker;
...
var
  form_pedidos_compras_001: Tform_pedidos_compras_001;

implementation

{$R *.lfm}

uses menu, pedidos_compras_000, proveedores_003, pedidos_compras_002, albaranes_compras_000;

{ Tform_pedidos_compras_001 }

procedure Tform_pedidos_compras_001.FormActivate(Sender: TObject);
begin
    // ********************************************************************************************* //
    // ** Si esta llamado desde otro modulo, le cambiamos el color de fondo                       ** //
    // ********************************************************************************************* //
    If form_pedidos_compras_000.public_Elegimos = true then
    begin
        with Self do
        begin
            Color := $00B9959C;
...
procedure Tform_pedidos_compras_001.FormCreate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
procedure Tform_pedidos_compras_001.para_Empezar;
begin
    // ********************************************************************************************* //
    // ** Solo para formularios que traten con datos                                              ** //
    // ********************************************************************************************* //
...
procedure Tform_pedidos_compras_001.Poner_Total_Lineas_Detalle;
begin
    Label_Ctdad_Rgtros.Caption := IntToStr(form_pedidos_compras_000.SQLQuery_Pdo_Detalles.RecordCount);
end;

procedure Tform_pedidos_compras_001.Presentar_Datos;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo do
    begin
        ...
        form_pedidos_compras_000.Presentar_Datos_Totales(1);
    end;
end;

procedure Tform_pedidos_compras_001.Presentar_Datos_Proveedor_Generales;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo do
    begin
...
procedure Tform_pedidos_compras_001.Presentar_Datos_Bancarios;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo do
    begin
...
procedure Tform_pedidos_compras_001.Presentar_Datos_Comerciales;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo do
    begin
...
procedure Tform_pedidos_compras_001.Presentar_Datos_Gestion_Cobro;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo do
    begin
...
procedure Tform_pedidos_compras_001.Presentar_Datos_Direccion_de_Envio;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo do
    begin
...
procedure Tform_pedidos_compras_001.Presentar_Datos_Agencia_de_Transporte;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo do
    begin
...
procedure Tform_pedidos_compras_001.Validacion( param_msg : TStrings );
var var_msg_2            : TStrings;
    var_Registro_Empresa : TEmpresas;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo do
    begin
        if Trim(FieldByName('Fecha_Pedido_Proveedor').AsString) = '' then
        begin
            param_msg.Add( '* Su fecha de pedido.');
        end;

        if Trim(FieldByName('Numero_Pedido_Proveedor').AsString) = '' then
        begin
            param_msg.Add( '* Su número de pedido.');
        end;
        ...
        begin
            param_msg.Add( '* La fecha de entrada nuestra.');
        end;
        ...
        // ** de las faltas                                                                   ** //
        // ************************************************************************************* //
        if (form_pedidos_compras_000.SQLQuery_Pdo.State = dsInsert) and
        ...
        begin
            ...
            begin
                ...
                var_Registro_Empresa := UTI_COMPRAS_Devolver_Numeracion_Pedido( var_msg_2,
...
procedure Tform_pedidos_compras_001.OKButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := true;
end;

procedure Tform_pedidos_compras_001.CancelButtonClick(Sender: TObject);
begin
    private_Salir_OK     := true;
    public_Pulso_Aceptar := false;
end;

procedure Tform_pedidos_compras_001.no_Tocar;
begin
    DBDateTimePicker_Fecha.Enabled             := false;
    DBDateTimePicker_Fecha_Pedido.Enabled      := false;
    DBEdit_Numero_Pedido.Enabled               := false;
...
procedure Tform_pedidos_compras_001.Refrescar_Registros;
begin
    form_pedidos_compras_000.Refrescar_Registros_Detalles;

    form_pedidos_compras_000.Presentar_Datos_Totales(1);
end;

procedure Tform_pedidos_compras_001.RadioGroup_BajasClick(Sender: TObject);
begin
    //UTI_TB_Ver_Bajas_SN('um', Memo_Filtros.Lines, RadioGroup_Bajas.ItemIndex);
    Refrescar_Registros;
end;

procedure Tform_pedidos_compras_001.BitBtn_Ver_Situacion_Registro_compras_detallesClick
  (Sender: TObject);
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, '', True) = True then
    begin
        if form_pedidos_compras_000.SQLQuery_Pdo_Detalles.RecordCount > 0 then
        begin
            UTI_RGTRO_Ver_Estado_Registro( 'pedidos_compras_detalles',
                                           form_pedidos_compras_000.SQLQuery_Pdo_Detalles,
                                           form_pedidos_compras_000.DataSource_Pdo_Detalles,
                                           DBGrid_Detalles );
        end;
    end;
end;

procedure Tform_pedidos_compras_001.DBGrid_DetallesDblClick(Sender: TObject);
begin
    Editar_Registro_Detalles;
end;

procedure Tform_pedidos_compras_001.DBGrid_DetallesDrawColumnCell( Sender: TObject;
                                                                   const Rect: TRect;
                                                                   DataCol: Integer;
                                                                   Column: TColumn;
...
begin
    ...
    begin
        if form_pedidos_compras_000.SQLQuery_Pdo_Detalles.RecordCount = 0 then Exit;
        ...
        // ***************************************************************************************** //
        if not form_pedidos_compras_000.SQLQuery_Pdo_Detalles.FieldByName('Del_WHEN').IsNull then
        begin
            // ********************************************************************************* //
            ...
            begin
                if (Column.FieldName <> 'Albaran_SN') then
                begin
        ...
        begin
            ...
            if (Column.FieldName <> 'Convertida_SN')     and
               (Column.FieldName <> 'Cobro_Excluido_SN') then
            begin
                if not form_pedidos_compras_000.SQLQuery_Pdo_Detalles.FieldByName('Serie_Albaran').IsNull then
                     Canvas.StretchDraw(Rect, form_pedidos_compras_000.Image_Convertida.Picture.Graphic)
                else DefaultDrawColumnCell(Rect, DataCol, Column, State);
            end;

            if Column.FieldName = 'Cobro_Excluido_SN'  then
            begin
                if form_pedidos_compras_000.SQLQuery_Pdo_Detalles.FieldByName('Excluido_su_Cobro_SN').Value = 'S' then
                     Canvas.StretchDraw(Rect, form_pedidos_compras_000.Image_Cobro_Excluido.Picture.Graphic)
                else DefaultDrawColumnCell(Rect, DataCol, Column, State);
            end;
        end;
...
procedure Tform_pedidos_compras_001.DBGrid_DetallesKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
    if Key = 13 then Editar_Registro_Detalles;
end;

procedure Tform_pedidos_compras_001.DBNavigator_DetallesBeforeAction(Sender: TObject; Button: TDBNavButtonType);
begin
    case Button of
        nbInsert : begin
...
procedure Tform_pedidos_compras_001.Boton_Elegir_EmpresaClick(Sender: TObject);
...
procedure Tform_pedidos_compras_001.Edit_Descripcion_EmpresaClick(Sender: TObject);
...
begin
    ...
    begin
         form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('id_empresas').Clear;
         Edit_Descripcion_Empresa.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_pedidos_compras_001.Boton_Elegir_AlmacenClick(Sender: TObject);
var var_Registro         : TRecord_Rgtro_Comun;
    var_msg              : TStrings;
...
procedure Tform_pedidos_compras_001.Edit_Descripcion_AlmacenClick(Sender: TObject);
var var_msg : TStrings;
begin
    if Cambiamos_Almacen_SN = false then Exit;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('id_almacenes').Clear;
         Edit_Descripcion_Almacen.Text := '';
    end;
    var_msg.Free;
end;

procedure Tform_pedidos_compras_001.Boton_Elegir_ProveedorClick(Sender: TObject);
...
procedure Tform_pedidos_compras_001.Edit_Descripcion_ProveedorClick(Sender: TObject);
begin
    if Cambiamos_Proveedor_SN = false then Exit;
...
procedure Tform_pedidos_compras_001.Boton_Elegir_Forma_PagoClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo do
    begin
...
procedure Tform_pedidos_compras_001.Edit_Descripcion_Forma_PagoClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    if UTI_GEN_Aviso(true, var_msg, rs_OK, True, True) = True then
    begin
         form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('id_formas_pago').Clear;
         Edit_Descripcion_Forma_Pago.Text := '';
    end;
    var_msg.Free;
end;

function Tform_pedidos_compras_001.Elegir_Contacto_del_Proveedor : TRecord_Rgtro_Comun;
var var_msg : TStrings;
begin
    Result.id_1 := '';

    if Trim(form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('id_proveedores').AsString) = '' then
    begin
        var_msg := TStringList.Create;
        var_msg.Add('No has elegido todavía ningún proveedor/acreedor para este pedido.');
    ...
    begin
        ...
        form_proveedores_003.Edit_id.Text       := form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('id_proveedores').AsString;
...
procedure Tform_pedidos_compras_001.Boton_Elegir_Contacto_ProveedorClick(Sender: TObject);
var var_Registro          : TRecord_Rgtro_Comun;
...
procedure Tform_pedidos_compras_001.Edit_Direccion_de_Envio_con_Quien_HablarClick(Sender: TObject);
begin
    Vaciar_Datos_Envio;
end;

procedure Tform_pedidos_compras_001.Vaciar_Datos_Envio;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
...
procedure Tform_pedidos_compras_001.Boton_Elegir_Poblacion_EnvioClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo do
    begin
...
procedure Tform_pedidos_compras_001.Edit_Direccion_de_Envio_PoblacionClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    begin
        ...
        form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('Envio_id_poblaciones').Clear;
        form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('OT_Envio_descripcion_poblacion').Clear;
    end;
    var_msg.Free;
end;

procedure Tform_pedidos_compras_001.Boton_Elegir_Provincia_EnvioClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo do
    begin
...
procedure Tform_pedidos_compras_001.Edit_Direccion_de_Envio_ProvinciaClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    begin
        ...
        form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('Envio_id_provincias').Clear;
        form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('OT_Envio_descripcion_provincia').Clear;
    end;
    var_msg.Free;
end;

procedure Tform_pedidos_compras_001.Boton_Elegir_Pais_EnvioClick(Sender: TObject);
var var_Registro : TRecord_Rgtro_Comun;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo do
    begin
...
procedure Tform_pedidos_compras_001.Edit_Direccion_de_Envio_PaisClick(Sender: TObject);
var var_msg : TStrings;
begin
    var_msg := TStringList.Create;
    ...
    begin
        ...
        form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('Envio_id_paises').Clear;
        form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('OT_Envio_descripcion_pais').Clear;
    end;
    var_msg.Free;
end;

procedure Tform_pedidos_compras_001.Boton_Elegir_Agencia_TransporteClick(Sender: TObject);
var var_Registro               : TRecord_Rgtro_Comun;
...
procedure Tform_pedidos_compras_001.Edit_Direccion_de_Envio_Agencia_Transporte_DescripcionClick(Sender: TObject);
begin
    Vaciar_Datos_Agencia_de_Transporte;
end;

procedure Tform_pedidos_compras_001.Vaciar_Datos_Agencia_de_Transporte;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
...
procedure Tform_pedidos_compras_001.Vaciar_Proveedor_Datos;
var var_msg : TStrings;
begin
    if UTI_USR_Permiso_SN(public_Menu_Worked, 'M', True) = True then
    begin
...
function Tform_pedidos_compras_001.Comprobar_No_Tocar( param_Reproducir_Mensajes,
...
begin
    ...
    // ********************************************************************************************* //
    if (not form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('Serie_Presupuesto').IsNull)  or
       (not form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('Numero_Presupuesto').IsNull) then
    begin
        Result := true;
        if param_Reproducir_Mensajes = true then
        begin
            var_msg.Add( '* Este pedido pertenece al presupuesto con la referencia nuestra ' +
                         Trim(form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('Serie_Presupuesto').AsString) +
                         '/' +
                         Trim(form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('Numero_Presupuesto').AsString) +
                         '. ' +
...
function Tform_pedidos_compras_001.Cambiamos_Proveedor_SN : Boolean;
var var_Estado_Lineas_Detalle : TUTI_COMPRAS_Ctdad_Rgtros_Detalle;
    var_msg                   : TStrings;
begin
    Result := true;

    if form_pedidos_compras_000.SQLQuery_Pdo_Detalles.Active = false then Exit;

    var_Estado_Lineas_Detalle := UTI_COMPRAS_Estado_Lineas_Detalle( form_pedidos_compras_000.SQLQuery_Pdo_Detalles,
                                                                    'Serie_Albaran',
                                                                    'Numero_Albaran' );

    if var_Estado_Lineas_Detalle.Total_Lineas_Sin_Marcar <> form_pedidos_compras_000.SQLQuery_Pdo_Detalles.RecordCount then
    begin
        var_msg := TStringList.Create;
...
function Tform_pedidos_compras_001.Cambiamos_Almacen_SN : Boolean;
var var_Estado_Lineas_Detalle : TUTI_COMPRAS_Ctdad_Rgtros_Detalle;
    var_msg                   : TStrings;
begin
    Result := true;

    with form_pedidos_compras_000 do
    begin
...
procedure Tform_pedidos_compras_001.Comprobar_desde_Detalles_Si_Cerramos_0;
begin
    // ********************************************************************************************* //
...
function Tform_pedidos_compras_001.Comprobar_desde_Detalles_Si_Cerramos_1 : Boolean;
var var_Estado_Lineas_Detalle : TUTI_COMPRAS_Ctdad_Rgtros_Detalle;
begin
    Result := false;
...
procedure Tform_pedidos_compras_001.BitBtn_Crear_Linea_como_AlbaranClick(Sender: TObject);
...
begin
    ...
    with form_pedidos_compras_000.SQLQuery_Pdo_Detalles do
    begin
        // ********************************************************************************************* //
        ...
        begin
            var_msg.Add( '* Esta línea ya pertenece al albarán con nuestra referencia ' +
    ...
    begin
        ...
        var_Registro_Empresa := form_pedidos_compras_000.Crear_Albaran_su_Cabecera( var_Fecha );
        ...
        begin
            form_pedidos_compras_000.Crear_Albaran_su_Detalle( var_Fecha,
...
procedure Tform_pedidos_compras_001.Insertar_Registro_Detalles;
var var_msg  : TStrings;
    var_Form : Tform_pedidos_compras_002;
begin
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                // ********************************************************************************* //
                UTI_IMPTOS_Asignar_Impto( form_pedidos_compras_000.SQLQuery_Pdo_Detalles,
                ...
                // ********************************************************************************* //
                FieldByName('id_almacenes').Value := form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('id_almacenes').Value;
                // ********************************************************************************* //

                FieldByName('id_proveedores').AsString          := form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('id_proveedores').AsString;
                FieldByName('Excluido_su_Cobro_SN').AsString := 'N';
                FieldByName('id_pedidos').AsString           := form_pedidos_compras_000.SQLQuery_Pdo.FieldByName('id').AsString;

                var_Form := Tform_pedidos_compras_002.Create(nil);
                ...
                begin
                    ...
                    UTI_RGTRO_Grabar_Antes( 'pedidos_compras_detalles',
                                            form_pedidos_compras_000.SQLQuery_Pdo_Detalles );
...
procedure Tform_pedidos_compras_001.Editar_Registro_Detalles;
var var_msg  : TStrings;
    var_Form : Tform_pedidos_compras_002;
    var_id   : ShortString;
begin
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                if var_Form.public_Pulso_Aceptar = true then
                begin
                    if UTI_DATOS_TABLA_SeCambioAlgoEnRgtro( form_pedidos_compras_000.SQLQuery_Pdo_Detalles ) = true then
                    begin
                        // ************************************************************************* //
...
procedure Tform_pedidos_compras_001.Borrar_Registro_Detalle;
var var_msg : TStrings;
begin
    if Comprobar_No_Tocar(true, false) = true then
    begin
    ...
    begin
        ...
        begin
            var_msg := TStringList.Create;
            var_msg.Add( 'Esta línea pertenece al albarán con nuestra referencia ' +
                         Trim(FieldByName('Serie_Albaran').AsString) +
                         '/' +
                         Trim(FieldByName('Numero_Albaran').AsString)  );
    ...
    begin
        UTI_RGTRO_Borrar( 'pedidos_compras_detalles',
                          form_pedidos_compras_000.SQLQuery_Pdo_Detalles,
                          public_Solo_Ver,
                          public_Menu_Worked );
...
procedure Tform_pedidos_compras_001.BitBtn_Ver_AlbaranClick(Sender: TObject);
var var_msg : TStrings;
begin
    with form_pedidos_compras_000.SQLQuery_Pdo_Detalles do
    begin
        ...
        begin
            ...
            begin
                // form_albaranes_compras_000.Editar_Registro;
...
function Tform_pedidos_compras_001.Traer_Empresas_xID( param_id : ShortString ) : TEmpresas;
...
function Tform_pedidos_compras_001.Traer_Proveedores_xID( param_id : ShortString ) : TProveedores;
var var_SQLTransaction : TSQLTransaction;
    var_SQLConnector   : TSQLConnector;
    var_SQLQuery       : TSQLQuery;
begin
...
function Tform_pedidos_compras_001.Traer_Proveedores_Contactos_xID( param_id : ShortString ) : TProveedores_Contactos;
var var_SQLTransaction : TSQLTransaction;
    var_SQLConnector   : TSQLConnector;
    var_SQLQuery       : TSQLQuery;
begin
...
procedure Tform_pedidos_compras_001.FormClose(Sender: TObject; var CloseAction: TCloseAction);
begin
    // las he puesto más abajo estas líneas porque no compilaba
end;
