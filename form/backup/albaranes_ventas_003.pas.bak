...
uses
  Classes, SysUtils, FileUtil, DBDateTimePicker, Forms, Controls, Graphics, Dialogs, StdCtrls, DbCtrls,
  Buttons, DBGrids, Grids, utilidades_general, LCLTranslator;

type

  { Tform_albaranes_ventas_003 }

  Tform_albaranes_ventas_003 = class(TForm)
...
var
  form_albaranes_ventas_003: Tform_albaranes_ventas_003;

implementation

{$R *.lfm}

uses menu, albaranes_ventas_000;

{ Tform_albaranes_ventas_003 }

procedure Tform_albaranes_ventas_003.FormActivate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
procedure Tform_albaranes_ventas_003.FormCreate(Sender: TObject);
begin
    // ********************************************************************************************* //
...
procedure Tform_albaranes_ventas_003.para_Empezar;
begin
    Presentar_Datos;
end;

procedure Tform_albaranes_ventas_003.Presentar_Datos;
begin
...
procedure Tform_albaranes_ventas_003.FormClose(Sender: TObject; var CloseAction: TCloseAction);
begin
...
procedure Tform_albaranes_ventas_003.FormDestroy(Sender: TObject);
begin
    form_albaranes_ventas_000.Cerramos_Tabla_Detalles_Stock;
end;

procedure Tform_albaranes_ventas_003.BitBtn_SALIRClick(Sender: TObject);
begin
...
procedure Tform_albaranes_ventas_003.DBGrid_DetallesDrawColumnCell( Sender: TObject;
                                                                    const Rect: TRect;
                                                                    DataCol: Integer;
                                                                    Column: TColumn;
...
begin
    ...
    begin
        if form_albaranes_ventas_000.SQLQuery_Alb_Detalles_Stock.RecordCount = 0 then Exit;
        ...
        begin
            ...
            if Column.FieldName = 'sin_Stock'  then
            begin
    	        if form_albaranes_ventas_000.SQLQuery_Alb_Detalles_Stock.FieldByName('OT_Stock_Resultado').Value < 0 then
                begin
                    Canvas.StretchDraw(Rect, form_albaranes_ventas_000.Image_Candado.Picture.Graphic);
                end else begin
                    DefaultDrawColumnCell(Rect, DataCol, Column, State);
                end;
            end;
...
procedure Tform_albaranes_ventas_003.DBNavigator_DetallesBeforeAction(Sender: TObject; Button: TDBNavButtonType);
begin
    case Button of
        nbRefresh : begin
            form_albaranes_ventas_000.Refrescar_Registros_Detalles_Stock;
            Abort;
        end;
    end;
end;
