...
begin
     if UTI_CN_Abrir(SQLTransaction_Users, SQLConnector_Users) = False then UTI_GEN_Salir;
     if UTI_CN_Abrir(SQLTransaction_Users_Menus, SQLConnector_Users_Menus) = False then UTI_GEN_Salir;
     if UTI_CN_Abrir(SQLTransaction_Users_Menus_Permisos, SQLConnector_Users_Menus_Permisos) = False then UTI_GEN_Salir;
     if UTI_CN_Abrir(SQLTransaction_Users_Passwords, SQLConnector_Users_Passwords) = False then UTI_GEN_Salir;
end;
