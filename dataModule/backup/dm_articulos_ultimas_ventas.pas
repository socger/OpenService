...
begin
    if UTI_CN_Abrir(SQLTransaction_Alb_V_D, SQLConnector_Alb_V_D) = False then UTI_GEN_Salir;
    if UTI_CN_Abrir(SQLTransaction_Ftra_V_D, SQLConnector_Ftra_V_D) = False then UTI_GEN_Salir;
    if UTI_CN_Abrir(SQLTransaction_Alb_C_D, SQLConnector_Alb_C_D) = False then UTI_GEN_Salir;
    if UTI_CN_Abrir(SQLTransaction_Ftra_C_D, SQLConnector_Ftra_C_D) = False then UTI_GEN_Salir;
end;
