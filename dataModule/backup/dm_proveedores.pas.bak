...
begin
    if UTI_CN_Abrir(SQLTransaction_Proveedores, SQLConnector_Proveedores) = False then UTI_GEN_Salir;
    if UTI_CN_Abrir(SQLTransaction_Proveedores_Contactos, SQLConnector_Proveedores_Contactos) = False then UTI_GEN_Salir;
end;
