...
begin
  if UTI_CN_Connector_Open( SQLTransaction_AO, SQLConnector_AO ) = False then UTI_GEN_Salir;
  if UTI_CN_Connector_Open( SQLTransaction_AODPV, SQLConnector_AODPV ) = False then UTI_GEN_Salir;
  if UTI_CN_Connector_Open( SQLTransaction_AOA, SQLConnector_AOA ) = False then UTI_GEN_Salir;
end;
