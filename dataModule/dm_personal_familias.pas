...
begin
    if UTI_CN_Connector_Open( SQLTransaction_PerFam, SQLConnector_PerFam ) = False then UTI_GEN_Salir;
    if UTI_CN_Connector_Open( SQLTransaction_PerFamSubFamilias, SQLConnector_PerFamSubFamilias ) = False then UTI_GEN_Salir;
end;
