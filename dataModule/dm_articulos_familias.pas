...
begin
  if UTI_CN_Connector_Open( SQLTransaction_ArtFam, SQLConnector_ArtFam ) = False then UTI_GEN_Salir;
  if UTI_CN_Connector_Open( SQLTransaction_ArtFamSubFamilias, SQLConnector_ArtFamSubFamilias ) = False then UTI_GEN_Salir;
  if UTI_CN_Connector_Open( SQLTransaction_ArtFamTerminales, SQLConnector_ArtFamTerminales ) = False then UTI_GEN_Salir;
  if UTI_CN_Connector_Open( SQLTransaction_ArtFamTarifas, SQLConnector_ArtFamTarifas ) = False then UTI_GEN_Salir;
end;
